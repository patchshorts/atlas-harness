/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-model-selection`.
 * @module @atlasai/atsh-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-model-selection'
