 ...
 * that consumes it.
 */
import type { PropsLocale, PropsRuntime } from '@atlasai/atsh-client-ui-slots'
...
import type { PendingWait } from '@atlasai/atsh-client-runtime/client'
import type { QuestionResponsePayload } from '@atlasai/atsh-api-remotes/client'
