/**
 * Package-owned invariant companion for `@atlasai/atsh-native-command`.
 * @module @atlasai/atsh-native-command/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-native-command'
