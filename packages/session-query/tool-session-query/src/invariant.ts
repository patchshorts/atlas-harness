/**
 * Package-owned invariant companion for `@atlasai/atsh-tool-session-query`.
 * @module @atlasai/atsh-tool-session-query/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-tool-session-query'
