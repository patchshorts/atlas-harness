...
import type { ConnectionHandle, SessionId } from '@atlasai/atsh-api-remotes/client'
...
import type { TypertContext } from '@atlasai/atsh-typert-protocol'
import type { MaybeSnapshotSelectorHook, SnapshotSelectorHook } from '@atlasai/atsh-client-ui-slots'
...
export { isAppendSurfaceEvent, isReplacementSurfaceEvent } from '@atlasai/atsh-session/surface'
...
export type { SubagentAddress, JobView } from '@atlasai/atsh-client-connection/client'
...
export type { SessionId } from '@atlasai/atsh-client-connection/client'
...
declare module '@atlasai/atsh-client-ui-slots' {
  /**
