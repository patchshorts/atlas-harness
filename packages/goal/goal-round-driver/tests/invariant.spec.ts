...
import * as GoalSessionInvariant from '@atlasai/atsh-goal-round-driver/invariant'
import { renderGoalRoundPrompt } from '@atlasai/atsh-goal-round-driver'
import InvariantRegistry, { InvariantError } from '@atlasai/atsh-invariants'
import SessionStore, { SessionId, type Session } from '@atlasai/atsh-session'
...
describe('goal-round-driver prompt invariants', () => {
  ...
  it('rejects a continuation whose content differs from the package renderer', async () => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@atlasai/atsh-goal-round-driver',
    }))
  })
