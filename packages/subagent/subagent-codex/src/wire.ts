 ...
 *
 * @module @atlasai/atsh-subagent-codex/wire
 */

import type { Readable, Writable } from 'node:stream'
import type { ContentBlock } from '@atlasai/atsh-llm'
import type { SubagentResult } from '@atlasai/atsh-subagent'
import { JsonRpcLineTransport } from '@atlasai/atsh-sdk-protocol'
