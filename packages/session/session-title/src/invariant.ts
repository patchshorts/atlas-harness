/**
 * Package-owned invariant companion for `@atlasai/atsh-session-title`.
 * @module @atlasai/atsh-session-title/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-session-title'
