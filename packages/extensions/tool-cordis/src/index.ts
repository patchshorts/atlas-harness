 ...
 * @module @atlasai/atsh-tool-cordis
 */
...
} from '@atlasai/atsh-cordis-host-runner'
import type { DynamicCordisReference } from '@atlasai/atsh-cordis-host-runner'
import { createUserMessage } from '@atlasai/atsh-llm'
import type { JsonValue } from '@atlasai/atsh-session'
import type { UserMessage } from '@atlasai/atsh-session'
...
function renderUnavailableReference(id: string): string {
  return [
    ...
    'It may have been removed, belong to another Session, or have been lost when the ATSH process restarted.',
