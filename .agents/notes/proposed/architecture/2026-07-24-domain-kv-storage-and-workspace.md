...
| --- | --- | --- | --- |
| `@atlasai/atsh-storage` | `packages/storage/storage/` | `ctx.storage` (the hub) | ✓ |
| `@atlasai/atsh-storage-json` | `packages/storage/storage-json/` | registers backend `json` | ✓ |
| `@atlasai/atsh-storage-sqlite` | `packages/storage/storage-sqlite/` | registers backend `sqlite` | ✓ |
| `@atlasai/atsh-storage-domain` | `packages/storage/storage-domain/` | mounts `ctx.storage.domain` | ✓ |
| `@atlasai/atsh-workspace` | `packages/workspace/workspace/` | `ctx.workspaceRegistry` | ✓ |
