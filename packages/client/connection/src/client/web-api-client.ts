...
import { hostFrameSchema, muxFrameSchema } from '@atlasai/atsh-host-apiproxy/api/events.schema'
import { serverRequestSchema } from '@atlasai/atsh-host-apiproxy/api/rpc.schema'
