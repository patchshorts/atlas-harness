 ...
 * one result.
 *
 * @module @atlasai/atsh-subagent-in-process-driver
 */

import { randomUUID } from 'node:crypto'
import type { Context } from '@deepseek-ai/cordis'
import { foldConsumedWork } from '@atlasai/atsh-agent'
...
import { createUserMessage, type ContentBlock } from '@atlasai/atsh-llm'
import {
