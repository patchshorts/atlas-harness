 ...
 */
import type { ConnectionHandle } from '@atlasai/atsh-api-remotes/client'
// Type-only: pulls the locale plugin's Context merge (ctx.locale).
import type {} from '@atlasai/atsh-client-locale/client'
// Type-only: the settings slot types (this package registers a General row).
import type {} from '@atlasai/atsh-client-ui-settings/client'
// Type-only: pulls the ctx.remote merge and the forwarded-event key face
// (the settings invalidation rides the allowlist) into this program.
import type {} from '@atlasai/atsh-api-remotes/client'
import type { ClientContext, SessionFace } from '@atlasai/atsh-client-runtime/client'
import type { CommandUiContract, SelectOption } from '@atlasai/atsh-client-ui-commands/client'
import type { ClientSessionContext } from '@atlasai/atsh-client-ui-input-trigger/client'
import type { PermissionSelect } from '@atlasai/atsh-permission-presets/client'
