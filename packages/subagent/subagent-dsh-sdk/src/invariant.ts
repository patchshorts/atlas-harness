/**
 * Package-owned invariant companion for `@atlasai/atsh-subagent-dsh-sdk`.
 * @module @atlasai/atsh-subagent-dsh-sdk/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-subagent-dsh-sdk'
