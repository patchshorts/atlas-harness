 ...
 * @module @atlasai/atsh-terminal-bash
 */

import { Context } from '@deepseek-ai/cordis'
import type { Agent } from '@atlasai/atsh-agent'
import type { Session, SessionEvent } from '@atlasai/atsh-session'
import { TerminalBackendCleanupError } from '@atlasai/atsh-terminal'
import type { TerminalBackend, TerminalBackendSpawnSpec } from '@atlasai/atsh-terminal'
import type { SubprocessTerminalHandle, SubprocessTerminalSpawnSpec } from '@atlasai/atsh-subprocess'
import type { SandboxExecutionPolicy } from '@atlasai/atsh-sandbox'
import { effectiveSandboxMode } from '@atlasai/atsh-sandbox-policy'
...
function childEnvironment(spec: TerminalBackendSpawnSpec): Record<string, string> {
  ...
  return {
    ...
    ATSH_SHELL: '1',
    ATSH_SESSION_ID: spec.owner.id,
    ATSH_PTY_SESSION_ID: spec.sessionId,
  }
}
