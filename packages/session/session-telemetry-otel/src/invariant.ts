/**
 * Package-owned invariant companion for `@atlasai/atsh-session-telemetry-otel`.
 * @module @atlasai/atsh-session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-session-telemetry-otel'
