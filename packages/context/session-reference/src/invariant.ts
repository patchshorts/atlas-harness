/**
 * Package-owned invariant companion for `@atlasai/atsh-session-reference`.
 * @module @atlasai/atsh-session-reference/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-session-reference'
