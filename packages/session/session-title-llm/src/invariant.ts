/**
 * Package-owned invariant companion for `@atlasai/atsh-session-title-llm`.
 * @module @atlasai/atsh-session-title-llm/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-session-title-llm'
