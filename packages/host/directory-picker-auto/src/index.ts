 ...
 * @module @atlasai/atsh-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@atlasai/atsh-host-directory-picker-native',
  browse: '@atlasai/atsh-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@atlasai/atsh-client-ui-directory-picker-native',
  browse: '@atlasai/atsh-client-ui-directory-picker-browse',
}
