...
import type { ChatFileMentions, TurnTailOwnerProps } from '@atlasai/atsh-client-ui-conversation/client'
import { makeTranslate, stubSettingsScope } from '@atlasai/atsh-client-test-runtime'
import {
...
describe('package shells', () => {
  it('the invariant companion registers ownership', async () => {
    ...
    expect(registered).toEqual(['@atlasai/atsh-client-ui-deliverables'])
