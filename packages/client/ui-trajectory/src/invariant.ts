/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-trajectory`.
 * @module @atlasai/atsh-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-trajectory'
