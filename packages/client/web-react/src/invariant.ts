/**
 * Package-owned invariant companion for `@atlasai/atsh-client-web-react`.
 * @module @atlasai/atsh-client-web-react/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-web-react'
