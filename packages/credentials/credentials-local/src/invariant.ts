/**
 * Package-owned invariant companion for `@atlasai/atsh-credentials-local`.
 * @module @atlasai/atsh-credentials-local/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-credentials-local'
