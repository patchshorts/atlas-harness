 ...
 * ({@link @atlasai/atsh-agent-spine-demo}), JSONL session persistence, and
 * the {@link @atlasai/atsh-acp} bridge. The app owns those plugins through one
 ...
 * @module @atlasai/atsh-acp-demo
 */

import type { Context } from '@deepseek-ai/cordis'
import { join } from 'node:path'
import z from '@deepseek-ai/schemastery'
import * as acp from '@atlasai/atsh-acp'
import * as agentCore from '@atlasai/atsh-agent-spine-demo'
...
} from '@atlasai/atsh-session-persistence-jsonl'
import * as sessionCheckpointPolicy from '@atlasai/atsh-session-checkpoint-policy'
