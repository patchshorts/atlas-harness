...
import * as SessionLogDownload from '@atlasai/atsh-session-log-export'
...
describe('session-log-download real Loader composition', () => {
  it('discovers and executes /export through the assembled command plane', async () => {
    ...
    await writeFile(configPath, [
      ...
      "- name: '@atlasai/atsh-session-log-export'",
      '',
    ].join('\n'))
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@atlasai/atsh-session-log-export', SessionLogDownload],
    ])
