 ...
 * @module @atlasai/atsh-tool-fs/src/write
 */

import type { Context } from '@deepseek-ai/cordis'
import { defineTool } from '@atlasai/atsh-tools'
import type { DiffCallView, DiffResultView, ToolResult } from '@atlasai/atsh-tools'
import type { FsWriteOutcome } from '@atlasai/atsh-fs'
