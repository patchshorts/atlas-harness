...
import { LocaleRuntime } from '@atlasai/atsh-client-locale/client'
import { apply as themeApply, inject as themeInject, ThemeRuntime } from '@atlasai/atsh-client-ui-theme/client'
import { apply, inject, LayoutController } from '@atlasai/atsh-client-ui-layout/client'
import { apply as nodeApply } from '@atlasai/atsh-client-ui-layout'
import * as invariant from '@atlasai/atsh-client-ui-layout/invariant'
...
describe('node half + invariant companion', () => {
  ...
  it('invariant companion registers under the package name', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@atlasai/atsh-client-ui-layout', expect.any(Function))
