/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-theme`.
 * @module @atlasai/atsh-client-ui-theme/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-theme'
