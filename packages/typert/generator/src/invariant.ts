/**
 * Package-owned invariant companion for `@atlasai/atsh-typert-generator`.
 * @module @atlasai/atsh-typert-generator/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-typert-generator'
