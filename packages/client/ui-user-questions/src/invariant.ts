/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-user-questions`.
 * @module @atlasai/atsh-client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-user-questions'
