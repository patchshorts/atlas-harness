...
import * as PluginConfigInvariant from '@atlasai/atsh-client-ui-settings-plugins/invariant'
...
describe('invariant companion', () => {
  ...
  it('has an empty node half', async () => {
    const { apply } = await import('@atlasai/atsh-client-ui-settings-plugins')
