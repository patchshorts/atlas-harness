/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-slots`.
 * @module @atlasai/atsh-client-ui-slots/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-slots'
