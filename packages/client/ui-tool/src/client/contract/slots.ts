...
import type { PropsLocale, PropsRenderSlots, PropsRuntime } from '@atlasai/atsh-client-ui-slots'
import type { ToolCallBlock } from '@atlasai/atsh-client-runtime/client'
