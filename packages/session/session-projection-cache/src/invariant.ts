/**
 * Package-owned invariant companion for `@atlasai/atsh-session-projection-cache`.
 * @module @atlasai/atsh-session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-session-projection-cache'
