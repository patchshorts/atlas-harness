 ...
 * not built (`pnpm --filter @atlasai/atsh-client-ui-trajectory bundle`).
 */
...
const PLUGIN_ID = '@atlasai/atsh-client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@atlasai/atsh-client-runtime/client', await import('@atlasai/atsh-client-runtime/client')],
      ['@atlasai/atsh-client-ui-primitives', await import('@atlasai/atsh-client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('@atlasai/atsh-client-locale/client')
