/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-message-feedback`.
 * @module @atlasai/atsh-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-message-feedback'
