...
import { apply, inject } from '@atlasai/atsh-client-ui-workspace/client'
import type { WorkspaceBrowserInjected, WorkspacePickerInjected } from '@atlasai/atsh-client-ui-workspace/client'
