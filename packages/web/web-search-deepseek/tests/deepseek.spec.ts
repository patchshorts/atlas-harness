...
} from '@atlasai/atsh-web-search-deepseek'
import * as deepseekPlugin from '@atlasai/atsh-web-search-deepseek'
import { citationSnippets, mapAnthropicResponse } from '../src/provider.ts'
import type { AnthropicResponse } from '@atlasai/atsh-web-search-deepseek/src/types.ts'

/** Construct the provider over a fixed options value; production passes a live thunk. */
import type { DeepSeekSearchProviderOptions } from '@atlasai/atsh-web-search-deepseek'
