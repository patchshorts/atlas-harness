/**
 * `@atlasai/atsh-web-search-exa`: registers an Exa-backed `WebSearchProvider`
 ...
 * seam's provider registry, exactly as `@atlasai/atsh-llm-deepseek`
 * registers an adapter into `ctx.llm`. The key is owned by `@atlasai/atsh-web`.
 *
 * @module @atlasai/atsh-web-search-exa
 */
