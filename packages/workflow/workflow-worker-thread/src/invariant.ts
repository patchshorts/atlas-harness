/**
 * Package-owned invariant companion for `@atlasai/atsh-workflow-worker-thread`.
 * @module @atlasai/atsh-workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-workflow-worker-thread'
