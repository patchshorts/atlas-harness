 ...
 * `__ATSH_BOOT__` wire types, the boot-manifest parser, and the boundaries around
...
export function parseBootManifest(wire: unknown): BootManifest {
  if (typeof wire !== 'object' || wire === null) {
    throw new Error('client-modules: window.__ATSH_BOOT__ is missing or not an object')
  }
...
export interface DshWindow {
   ...
   */
  __ATSH_MODULES__?: ClientModuleSystem
}
