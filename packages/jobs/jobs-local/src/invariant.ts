/**
 * Package-owned invariant companion for `@atlasai/atsh-jobs-local`.
 * @module @atlasai/atsh-jobs-local/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-jobs-local'
...
/**
 * No runtime invariant: `@atlasai/atsh-jobs/invariant` owns per-snapshot identity, status,
