/**
 * Package-owned invariant companion for `@atlasai/atsh-tool-str-replace-editor`.
 * @module @atlasai/atsh-tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-tool-str-replace-editor'
