...
import { parseSessionLog } from '@atlasai/atsh-llm-replay'
import type { SessionEvent, SessionId } from '@atlasai/atsh-session'
import type {} from '@atlasai/atsh-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@atlasai/atsh-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@atlasai/atsh-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@atlasai/atsh-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@atlasai/atsh-skill-filesystem"}\n',
