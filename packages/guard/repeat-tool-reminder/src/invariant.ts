/**
 * Package-owned invariant companion for `@atlasai/atsh-repeat-tool-reminder`.
 * @module @atlasai/atsh-repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-repeat-tool-reminder'
