/**
 * Package-owned invariant companion for `@atlasai/atsh-launch-environment`.
 * @module @atlasai/atsh-launch-environment/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-launch-environment'
