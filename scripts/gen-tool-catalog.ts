...
import type { ToolSchema } from '@atlasai/atsh-llm'
import AgentRegistry from '@atlasai/atsh-agent'
import type { Agent } from '@atlasai/atsh-agent'
import { createScope } from '@atlasai/atsh-scope'
import SessionStore, { SessionId } from '@atlasai/atsh-session'
import SessionProjectionRegistry from '@atlasai/atsh-session-projection'
import SqliteSessionQueryEngine from '@atlasai/atsh-session-query-sqlite'
import GoalService from '@atlasai/atsh-goal'
import SystemPrompt from '@atlasai/atsh-system-prompt'
import ToolRuntime, { type Config as ToolsConfig } from '@atlasai/atsh-tools'
import LocalBashExecutor from '@atlasai/atsh-bash-local'
import * as BashEnvPlugin from '@atlasai/atsh-shell-env'
import { PwshLocalExecutor } from '@atlasai/atsh-pwsh-local'
import LocalSubprocessRuntime from '@atlasai/atsh-subprocess-local'
import LocalFileSystem from '@atlasai/atsh-fs-local'
import { AttachmentStore } from '@atlasai/atsh-attachment'
import type { ImageAttachmentLimits, ImageAttachmentRef, SaveImageAttachment, StoredImageAttachment } from '@atlasai/atsh-attachment'
import UserQuestionService from '@atlasai/atsh-user-questions'
import PlanModeController from '@atlasai/atsh-plan-mode'
import WebRuntime from '@atlasai/atsh-web'
import * as WebSearchExa from '@atlasai/atsh-web-search-exa'
import * as WebFetchLocal from '@atlasai/atsh-web-fetch-http'
import SubagentRuntime from '@atlasai/atsh-subagent'
import type { SubagentProvider, SubagentReportDelivery } from '@atlasai/atsh-subagent'
import * as ToolSubagentControl from '@atlasai/atsh-tool-subagent-control'
import * as ToolSubagentListAgents from '@atlasai/atsh-tool-subagent-control/list-agents'
import * as ToolSubagentReport from '@atlasai/atsh-tool-subagent-report'
import SkillRegistry from '@atlasai/atsh-skill'
import * as SkillFileSystem from '@atlasai/atsh-skill-filesystem'
import LocalJobRegistry from '@atlasai/atsh-jobs-local'
import * as ToolAskUser from '@atlasai/atsh-tool-ask-user'
import * as ToolBash from '@atlasai/atsh-tool-bash'
import * as ToolPwsh from '@atlasai/atsh-tool-pwsh'
import * as ToolBashPersistent from '@atlasai/atsh-tool-bash-persistent'
import CordisHostRunner from '@atlasai/atsh-cordis-host-runner'
import * as ToolCordis from '@atlasai/atsh-tool-cordis'
import * as ToolFs from '@atlasai/atsh-tool-fs'
import * as ToolFsSearch from '@atlasai/atsh-tool-fs-search'
import * as ToolStrReplaceEditor from '@atlasai/atsh-tool-str-replace-editor'
...
import * as ToolSchedule from '@atlasai/atsh-schedule'
import Lsp from '@atlasai/atsh-lsp'
import * as ToolLsp from '@atlasai/atsh-tool-lsp'
import * as ToolSkill from '@atlasai/atsh-tool-skill'
import * as ToolSessionQuery from '@atlasai/atsh-tool-session-query'
import * as ToolTasks from '@atlasai/atsh-tool-jobs'
import * as ToolTodo from '@atlasai/atsh-tool-todo'
import * as ToolSubagent from '@atlasai/atsh-tool-subagent'
import * as ToolWeb from '@atlasai/atsh-tool-web'
import VmWorkflowEngine from '@atlasai/atsh-workflow-worker-thread'
import * as ToolRalph from '@atlasai/atsh-tool-ralph'
import * as ToolWorkflow from '@atlasai/atsh-tool-workflow'
import * as Memory from '@atlasai/atsh-memory'
import * as ToolMemory from '@atlasai/atsh-tool-memory'
import * as KGraph from '@atlasai/atsh-kgraph'
import * as ToolKGraph from '@atlasai/atsh-tool-kgraph'
import ResearchService from '@atlasai/atsh-research'
import * as ToolResearch from '@atlasai/atsh-tool-research'
import FactoryService from '@atlasai/atsh-factory'
import * as ToolFactory from '@atlasai/atsh-tool-factory'
...
const TOOL_PACKAGES: ToolPackage[] = [
  {
    pkg: '@atlasai/atsh-tool-ask-user',
    dir: 'tool-ask-user',
  ...
  },
  {
    ...
    note:
      'The bash tool is the model-facing consumer of the bash executor seam. A `run_in_background` run registers with the generic `ctx.jobs` runtime and is collected/stopped through the `job_*` tools from `@atlasai/atsh-tool-jobs`; the `enableRunInBackground` config (default true) removes the parameter entirely when disabled.',
  },
  {
    pkg: '@atlasai/atsh-tool-pwsh',
    dir: 'tool-pwsh',
    ...
    note:
      'The pwsh tool is the PowerShell-dialect consumer of the bash executor seam for Windows compositions (a PowerShell executor such as `@atlasai/atsh-pwsh-local` backs `ctx.shell`); it mirrors the bash tool call-for-call minus sandbox controls — `run_in_background` runs register with the generic `ctx.jobs` runtime and are collected/stopped through the `job_*` tools, and the managed `ATSH_*` environment comes from `@atlasai/atsh-shell-env`. Each call runs in a fresh process (no persistent PTY session), with native `C:\\...` paths and `$env:NAME` variables.',
  },
  {
    pkg: '@atlasai/atsh-tool-cordis',
    dir: 'tool-cordis',
    ...
    note:
      'Not in any shipped tree (a deliberate opt-in — dynamic package code reaches the real runtime, see .agents/notes/implemented/feature/2026-07-08-self-referential-cordis-toolset.md). The toolset injects `ctx.dynamicCordisRunner` from `@atlasai/atsh-cordis-host-runner`, which owns the definition registry and the vm sandbox; a composition missing it never activates the tools. A running package may register ADDITIONAL model-visible tools until it is stopped, undefined, or ATSH restarts; a full changed request header logs those tool-set changes.',
  },
  {
    pkg: '@atlasai/atsh-tool-bash-persistent',
  ...
  {
    pkg: '@atlasai/atsh-tool-str-replace-editor',
  ...
  },
  {
    ...
    note:
      'The read-before-write/edit policy is added by `@atlasai/atsh-fs-observation-policy` (an `fs/*` event-gate plugin, no schema change); a deployment that loads these tools is expected to also load it. `read_image` is not registered without `ctx.attachments`; its schema is route-independent, and execution refuses unless the exact routed model declares image input.',
  },
  {
    pkg: '@atlasai/atsh-tool-fs-search',
    dir: 'tool-fs-search',
  ...
  {
    pkg: '@atlasai/atsh-tool-terminal',
    dir: 'tool-terminal',
  ...
  },
  {
    ...
    note:
      'The lsp tool keeps provider selection and language-server subprocesses behind ctx.lsp, so its model-visible schema stays stable across providers. Requires a registered provider (e.g. `@atlasai/atsh-lsp-stdio`) at runtime; without one, a query returns the structured `LSP_UNAVAILABLE` error rather than changing the schema.',
  },
  {
    pkg: '@atlasai/atsh-tool-ralph',
    dir: 'tool-ralph',
  ...
  },
  {
    ...
    async mount(ctx) {
      ...
      await ctx.plugin(SkillFileSystem, {
        atshHome: resolve(root, '.tmp/tool-catalog/.dsh'),
  ...
  {
    pkg: '@atlasai/atsh-tool-session-query',
  ...
  {
    pkg: '@atlasai/atsh-tool-subagent',
    dir: 'tool-subagent',
  ...
  {
    pkg: '@atlasai/atsh-tool-subagent-control',
  ...
  {
    pkg: '@atlasai/atsh-tool-subagent-report',
  ...
  {
    pkg: '@atlasai/atsh-tool-workflow',
    dir: 'tool-workflow',
  ...
  {
    pkg: '@atlasai/atsh-tool-memory',
    dir: 'tool-memory',
    source: 'packages/memory/tool-memory/src/index.ts',
    requires: ['ctx.tools', 'ctx.memoryStore'],
    writes: ['tool/call', 'tool/result'],
    async mount(ctx) {
    ...
    note:
      'memory_recall, memory_retain, and memory_reflect expose the semantic memory seam; the default SQLite backend needs no external service.',
  },
  {
    pkg: '@atlasai/atsh-tool-kgraph',
    dir: 'tool-kgraph',
    source: 'packages/kgraph/tool-kgraph/src/index.ts',
    requires: ['ctx.tools', 'ctx.kgraph'],
    writes: ['tool/call', 'tool/result'],
    async mount(ctx) {
      await ctx.plugin(KGraph)
      await ctx.plugin(ToolKGraph)
    },
    note:
      'kgraph_upsert_objective, kgraph_record_evidence, and kgraph_query expose the OKR knowledge-graph seam; the default SQLite store needs no external service.',
  },
  {
    pkg: '@atlasai/atsh-tool-research',
    dir: 'tool-research',
    ...
    note:
      'xurl_search and arxiv_search expose the research seam; both degrade to empty results when their external source is unavailable.',
  },
  {
    pkg: '@atlasai/atsh-tool-factory',
    dir: 'tool-factory',
    source: 'packages/factory/tool-factory/src/index.ts',
    requires: ['ctx.tools', 'ctx.factory'],
    writes: ['tool/call', 'tool/result'],
    async mount(ctx) {
      await ctx.plugin(FactoryService)
      await ctx.plugin(ToolFactory)
    },
    note:
      'bar_critic and contract_status expose the factory critic seam over the plan-contract registry.',
  },
]
...
export function assertManifestComplete(packages: ToolPackage[] = TOOL_PACKAGES, scanRoot: string = root): void {
  // `packages/guard/` is the loop-hygiene + tool-gate group: these plugins wrap
  // the tool pipeline but register NO model-facing `ctx.tools` schema, so they
  // can never satisfy `assertToolsHarvested` (which requires >0 harvested
  // tools) and do not belong in the model-facing tool catalog. Exclude the
  // group here so a `tool-*`-named gate (e.g. `guard/tool-allowlist`) is not
  // falsely reported as an undocumented model tool.
  const onDisk = globSync('packages/*/tool-*', { cwd: scanRoot })
    .filter(p => !p.startsWith('packages/guard/'))
