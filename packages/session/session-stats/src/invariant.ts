/**
 * Package-owned invariant companion for `@atlasai/atsh-session-stats`.
 * @module @atlasai/atsh-session-stats/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-session-stats'
