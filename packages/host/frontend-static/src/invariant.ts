/**
 * Package-owned invariant companion for `@atlasai/atsh-host-frontend-static`.
 * @module @atlasai/atsh-host-frontend-static/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@atlasai/atsh-invariants'

const PACKAGE_NAME = '@atlasai/atsh-host-frontend-static'
