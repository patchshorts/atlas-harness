...
This overlay opts one `atsh web` process into Schedule reminders without changing the shipped default Web composition:

```sh
atsh web --patch examples/web-schedule/cordis.yml
```
