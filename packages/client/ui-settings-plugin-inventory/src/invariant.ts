/** Package-owned invariant companion. @module @atlasai/atsh-client-ui-settings-plugin-inventory/invariant */

/* jscpd:ignore-start */
import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@atlasai/atsh-invariants'

const PACKAGE_NAME = '@atlasai/atsh-client-ui-settings-plugin-inventory'
