 ...
 * @module @atlasai/atsh-headless/startup
 */
...
export function apply(ctx: Context): void {
  ...
  program.action(() => {
    ...
    if (task.trim() === '') program.error('error: a task is required, for example: atsh --profile headless "run the tests"')
