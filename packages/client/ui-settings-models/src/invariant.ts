/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-settings-models`.
 * @module @atlasai/atsh-client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-settings-models'
