/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-deliverables`.
 * @module @atlasai/atsh-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-deliverables'
