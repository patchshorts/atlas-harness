 ...
 * @module @atlasai/atsh-tool-ralph
 */
...
import type { SubagentProvider } from '@atlasai/atsh-subagent'
import { defineTool } from '@atlasai/atsh-tools'
import type { ToolCallView, ToolResultView } from '@atlasai/atsh-tools'
import type { WorkflowResult, WorkflowRun } from '@atlasai/atsh-workflow'
