/**
 * Package-owned invariant companion for `@atlasai/atsh-tool-subagent`.
 * @module @atlasai/atsh-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-tool-subagent'
