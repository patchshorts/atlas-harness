...
import { apply as nodeApply } from '@atlasai/atsh-client-locale'
import { apply as clientApply, COMMON_NS, LocaleRuntime, inject } from '@atlasai/atsh-client-locale/client'
import * as LocaleInvariant from '@atlasai/atsh-client-locale/invariant'
