/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-settings-general`.
 * @module @atlasai/atsh-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-settings-general'
