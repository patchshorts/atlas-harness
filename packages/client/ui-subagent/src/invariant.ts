/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-subagent`.
 * @module @atlasai/atsh-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-subagent'
