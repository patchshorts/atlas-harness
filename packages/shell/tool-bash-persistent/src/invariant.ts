/**
 * Package-owned invariant companion for `@atlasai/atsh-tool-bash-persistent`.
 * @module @atlasai/atsh-tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-tool-bash-persistent'
