/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-jobs`.
 * @module @atlasai/atsh-client-ui-jobs/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-jobs'
