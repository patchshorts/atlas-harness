/**
 * Package-owned invariant companion for `@atlasai/atsh-compaction-tool-result-pruner`.
 * @module @atlasai/atsh-compaction-tool-result-pruner/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-compaction-tool-result-pruner'
