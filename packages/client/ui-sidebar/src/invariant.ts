/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-sidebar`.
 * @module @atlasai/atsh-client-ui-sidebar/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-sidebar'
