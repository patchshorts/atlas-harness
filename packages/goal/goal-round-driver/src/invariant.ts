/** Package-owned goal-round prompt invariants. @module @atlasai/atsh-goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@deepseek-ai/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@atlasai/atsh-goal'
...
const PACKAGE_NAME = '@atlasai/atsh-goal-round-driver'
