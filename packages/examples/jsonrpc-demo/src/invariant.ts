/**
 * Package-owned invariant companion for `@atlasai/atsh-sdk-jsonrpc-demo`.
 * @module @atlasai/atsh-sdk-jsonrpc-demo/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-sdk-jsonrpc-demo'
