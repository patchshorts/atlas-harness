 ...
 *
 * The seam itself lives in `@atlasai/atsh-compaction`, which re-exports these
 ...
 *
 * @module @atlasai/atsh-compaction/checkpoint
 */

import type { MessageSource } from '@atlasai/atsh-llm/message'
