/**
 * Package-owned invariant companion for `@atlasai/atsh-hooks-claude-code`.
 * @module @atlasai/atsh-hooks-claude-code/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-hooks-claude-code'
