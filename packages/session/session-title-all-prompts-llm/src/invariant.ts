/**
 * Package-owned invariant companion for `@atlasai/atsh-session-title-all-prompts-llm`.
 * @module @atlasai/atsh-session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-session-title-all-prompts-llm'
