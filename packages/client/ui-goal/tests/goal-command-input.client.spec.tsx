...
import { ConversationNodeAssembler } from '@atlasai/atsh-client-runtime/client'
...
import type { SessionEvent } from '@atlasai/atsh-session/types'
import { commandDefinition } from '@atlasai/atsh-client-ui-conversation/src/client/conversation-nodes/command.ts'
import { chatViewDefinition } from '@atlasai/atsh-client-ui-conversation/src/client/conversation-nodes/chat-snapshot-builder.ts'
