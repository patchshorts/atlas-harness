/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-conversation`.
 * @module @atlasai/atsh-client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-conversation'
