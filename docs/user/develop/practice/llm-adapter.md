...
import { LlmAdapter, type GenerateOptions, type StreamChunk } from '@atlasai/atsh-llm'
...
```ts
import { CallId, type StreamChunk } from '@atlasai/atsh-llm'
