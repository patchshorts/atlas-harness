/**
 * Package-owned invariant companion for `@atlasai/atsh-anonymous-user-id`.
 * @module @atlasai/atsh-anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-anonymous-user-id'
