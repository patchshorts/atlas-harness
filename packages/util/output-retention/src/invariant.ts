/**
 * Package-owned invariant companion for `@atlasai/atsh-output-retention`.
 * @module @atlasai/atsh-output-retention/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-output-retention'
