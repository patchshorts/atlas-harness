 ...
 * atoms' label props (`@atlasai/atsh-client-ui-attachment` reads no
...
} from '@atlasai/atsh-client-ui-attachment'
import type { ImageAttachmentLimits } from '@atlasai/atsh-attachment'
