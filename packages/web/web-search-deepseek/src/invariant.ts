/**
 * Package-owned invariant companion for `@atlasai/atsh-web-search-deepseek`.
 * @module @atlasai/atsh-web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-web-search-deepseek'
