/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-cordis`.
 * @module @atlasai/atsh-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-cordis'
