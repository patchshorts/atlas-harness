/**
 * Package-owned invariant companion for `@atlasai/atsh-agent-spine-demo`.
 * @module @atlasai/atsh-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-agent-spine-demo'
