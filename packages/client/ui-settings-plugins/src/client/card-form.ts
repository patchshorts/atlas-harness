...
import type { SettingsScope, SettingsScopeSnapshot } from '@atlasai/atsh-client-runtime/client'
import { createSnapshotStore, type SnapshotStore } from '@atlasai/atsh-client-runtime/client'
