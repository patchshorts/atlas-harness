...
import {
  ...
  REGION_BEGIN,
  REGION_END,
} from '@atlasai/atsh-typert-generator'
import type { CordisCatalogPolicy } from '@atlasai/atsh-typert-generator'
...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  memoryStore: 'atlas-additions.md',
  llmRouter: 'atlas-additions.md',
  routerTrainer: 'atlas-additions.md',
  llmCache: 'atlas-additions.md',
  kgraph: 'atlas-additions.md',
  accounting: 'atlas-additions.md',
  coordination: 'atlas-additions.md',
  research: 'atlas-additions.md',
  factory: 'atlas-additions.md',
  factoryJudge: 'atlas-additions.md',
  judgeGate: 'atlas-additions.md',
  contextDebt: 'atlas-additions.md',
  budgetRouter: 'atlas-additions.md',
  laneGuard: 'atlas-additions.md',
  guardToolAllowlist: 'atlas-additions.md',
  observability: 'atlas-additions.md',
  promptCorpus: 'atlas-additions.md',
  promptLume: 'atlas-additions.md',
  promptContextTrim: 'atlas-additions.md',
  bench: 'atlas-additions.md',
}
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  atshHomePath: 'not a service: boot-provided root accessor function (typeof atshHomePath | undefined) for Loader !!js config expressions — packages/boot/app-boot/README.md owns the boot contract',
...
export const EVENT_SCOPE_PAGE: Record<string, string> = {
  ...
  'accounting': 'atlas-additions.md',
  'cache': 'atlas-additions.md',
  'coordination': 'atlas-additions.md',
  'factory': 'atlas-additions.md',
  'judge': 'atlas-additions.md',
  'context-debt': 'atlas-additions.md',
  'budget': 'atlas-additions.md',
  'lane': 'atlas-additions.md',
  'guard': 'atlas-additions.md',
  'observability': 'atlas-additions.md',
  'research': 'atlas-additions.md',
  'router': 'atlas-additions.md',
  'prompt-lume': 'atlas-additions.md',
  'bench': 'atlas-additions.md',
}
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ContextDebtKind: 'service-local shape is owned by packages/session/session-context-debt/src/types.ts',
  ContextDebtReport: 'service-local shape is owned by packages/session/session-context-debt/src/types.ts',
  ContextDebtScan: 'service-local shape is owned by packages/session/session-context-debt/src/types.ts',
  CompactionPlan: 'service-local shape is owned by packages/session/session-context-debt/src/types.ts',
  ContextDebtConfig: 'service-local shape is owned by packages/session/session-context-debt/src/types.ts',
  BudgetRouteState: 'service-local shape is owned by packages/factory/factory-budget-router/src/types.ts',
  ModelCost: 'service-local shape is owned by packages/factory/factory-budget-router/src/types.ts',
  StageRoute: 'service-local shape is owned by packages/factory/factory-budget-router/src/types.ts',
  BudgetRouterConfig: 'service-local shape is owned by packages/factory/factory-budget-router/src/types.ts',
  BudgetVetoRecord: 'event-local payload is owned by packages/factory/factory-budget-router/src/types.ts',
  BudgetRouteDecision: 'event-local payload is owned by packages/factory/factory-budget-router/src/types.ts',
  BatchRequest: 'service-local shape is owned by packages/factory/factory-budget-router/src/types.ts',
  BatchGroup: 'service-local shape is owned by packages/factory/factory-budget-router/src/types.ts',
  BatchPlan: 'service-local shape is owned by packages/factory/factory-budget-router/src/types.ts',
  CostReportEntry: 'service-local shape is owned by packages/factory/factory-budget-router/src/types.ts',
  CostReport: 'service-local shape is owned by packages/factory/factory-budget-router/src/types.ts',
  priceTokens: 'package-local pricing export is owned by packages/factory/factory-budget-router/src/pricing.ts',
  GuardReason: 'event-local payload union is owned by packages/bench/bench/src/run/guard.ts',
  MemoryGetOptions: 'service-local shape is owned by packages/memory/memory/src/types.ts',
  MemoryListOptions: 'service-local shape is owned by packages/memory/memory/src/types.ts',
  CorrectionRecord: 'service-local shape is owned by packages/router/trainer/src/types.ts',
  ...
  AccountingDebitRecord: 'event-local payload is owned by packages/accounting/accounting/src/types.ts',
  AccountingGrantRecord: 'event-local payload is owned by packages/accounting/accounting/src/types.ts',
  AccountingStats: 'service-local counters are owned by packages/accounting/accounting/src/types.ts',
  LedgerRow: 'service-local ledger shape is owned by packages/accounting/accounting/src/types.ts',
  CacheHitRecord: 'event-local payload is owned by packages/cache/cache/src/types.ts',
  CacheMissRecord: 'event-local payload is owned by packages/cache/cache/src/types.ts',
  CacheStats: 'service-local counters are owned by packages/cache/cache/src/types.ts',
  RouterCallRecord: 'event-local payload is owned by packages/router/router/src/types.ts',
  RouterRoute: 'service-local route shape is owned by packages/router/router/src/types.ts',
  TrainingSample: 'service-local sample shape is owned by packages/router/trainer/src/types.ts',
  WorkerStatus: 'event-local status vocabulary is owned by packages/coordination/coordination/src/types.ts',
  CoordinationStats: 'service-local counters are owned by packages/coordination/coordination/src/types.ts',
  SharedStateEntry: 'service-local shared-state shape is owned by packages/coordination/coordination/src/types.ts',
  WorkerRecord: 'service-local worker shape is owned by packages/coordination/coordination/src/types.ts',
  ResearchPaper: 'service-local paper shape is owned by packages/research/research/src/types.ts',
  ResearchPost: 'service-local post shape is owned by packages/research/research/src/types.ts',
  ResearchStats: 'service-local counters are owned by packages/research/research/src/types.ts',
  BarSubmission: 'service-local submission shape is owned by packages/factory/factory/src/types.ts',
  BarVerdict: 'service-local verdict shape is owned by packages/factory/factory/src/types.ts',
  ContractScore: 'service-local score shape is owned by packages/factory/factory/src/types.ts',
  FactoryPlanTask: 'service-local task shape is owned by packages/factory/factory/src/types.ts',
  PlannerInput: 'service-local input shape is owned by packages/factory/factory/src/types.ts',
  JudgeKind: 'service-local kind vocabulary is owned by packages/factory/factory-judge/src/types.ts',
  JudgePanelRole: 'service-local panel-role vocabulary is owned by packages/factory/factory-judge/src/types.ts',
  JudgeVote: 'service-local ballot shape is owned by packages/factory/factory-judge/src/types.ts',
  JudgePlanTask: 'service-local task shape is owned by packages/factory/factory-judge/src/types.ts',
  JudgeSubmission: 'service-local submission shape is owned by packages/factory/factory-judge/src/types.ts',
  JudgeTriage: 'service-local triage shape is owned by packages/factory/factory-judge/src/types.ts',
  JudgeRequest: 'service-local request shape is owned by packages/factory/factory-judge/src/types.ts',
  JudgeVerdict: 'service-local verdict shape is owned by packages/factory/factory-judge/src/types.ts',
  JudgeVerdictKind: 'service-local verdict vocabulary is owned by packages/factory/factory-judge/src/types.ts',
  JudgeConfig: 'service-local config shape is owned by packages/factory/factory-judge/src/types.ts',
  JudgeReplanState: 'service-local replan-budget shape is owned by packages/factory/factory-judge/src/types.ts',
  JudgeApprovalRecord: 'service-local approval record shape is owned by packages/factory/factory-judge/src/types.ts',
  JudgeGateAdmissionInput: 'service-local admission request shape is owned by packages/guard/judge-gate/src/types.ts',
  JudgeGateCompletionInput: 'service-local completion/exit request shape is owned by packages/guard/judge-gate/src/types.ts',
  ToolAllowlistDenyEvent: 'event-local deny payload is owned by packages/guard/tool-allowlist/src/index.ts',
  AllowDecision: 'service-local decision shape is owned by packages/factory/factory-lane-guard/src/types.ts',
  AllowPolicy: 'service-local policy shape is owned by packages/factory/factory-lane-guard/src/types.ts',
  Channel: 'service-local lane vocabulary is owned by packages/factory/factory-lane-guard/src/types.ts',
  ChanneledMessage: 'service-local lane-marked message shape is owned by packages/factory/factory-lane-guard/src/types.ts',
  DefenseResult: 'service-local defense result shape is owned by packages/factory/factory-lane-guard/src/types.ts',
  FactTriple: 'service-local triple shape is owned by packages/factory/factory-lane-guard/src/types.ts',
  InjectionPayload: 'service-local payload shape is owned by packages/factory/factory-lane-guard/src/types.ts',
  LaneGuardConfig: 'service-local config shape is owned by packages/factory/factory-lane-guard/src/types.ts',
  LaneVetoRecord: 'event-local payload is owned by packages/factory/factory-lane-guard/src/types.ts',
  PayloadClass: 'service-local taxonomy vocabulary is owned by packages/factory/factory-lane-guard/src/types.ts',
  SanitizeHit: 'service-local strip-hit shape is owned by packages/factory/factory-lane-guard/src/types.ts',
  SanitizeResult: 'service-local result shape is owned by packages/factory/factory-lane-guard/src/types.ts',
  TaintVerdict: 'service-local verdict shape is owned by packages/factory/factory-lane-guard/src/types.ts',
  ObsStage: 'service-local stage vocabulary is owned by packages/factory/factory-observability/src/types.ts',
  ObsEvent: 'event-local payload is owned by packages/factory/factory-observability/src/types.ts',
  SignalSeverity: 'service-local severity vocabulary is owned by packages/factory/factory-observability/src/types.ts',
  FailureSignal: 'service-local signal shape is owned by packages/factory/factory-observability/src/types.ts',
  SignalMetrics: 'service-local metrics shape is owned by packages/factory/factory-observability/src/types.ts',
  SignalVerdict: 'service-local verdict vocabulary is owned by packages/factory/factory-observability/src/types.ts',
  SignalReport: 'service-local report shape is owned by packages/factory/factory-observability/src/types.ts',
  CompletionCheck: 'service-local check shape is owned by packages/factory/factory-observability/src/types.ts',
  CompletionClaim: 'service-local claim shape is owned by packages/factory/factory-observability/src/types.ts',
  CompletionVerdict: 'service-local verdict shape is owned by packages/factory/factory-observability/src/types.ts',
  VerifierFixture: 'service-local fixture shape is owned by packages/factory/factory-observability/src/types.ts',
  VerifierStats: 'service-local stats shape is owned by packages/factory/factory-observability/src/types.ts',
  ReplayPatch: 'service-local patch shape is owned by packages/factory/factory-observability/src/types.ts',
  ReplayResult: 'service-local result shape is owned by packages/factory/factory-observability/src/types.ts',
  ObservabilityConfig: 'service-local config shape is owned by packages/factory/factory-observability/src/types.ts',
  AddEvidenceInput: 'service-local input shape is owned by packages/kgraph/kgraph/src/types.ts',
  AddKeyResultInput: 'service-local input shape is owned by packages/kgraph/kgraph/src/types.ts',
  Evidence: 'service-local evidence shape is owned by packages/kgraph/kgraph/src/types.ts',
  GraphBuildResult: 'service-local result shape is owned by packages/kgraph/kgraph/src/types.ts',
  KGraphStats: 'service-local counters are owned by packages/kgraph/kgraph/src/types.ts',
  KeyResult: 'service-local KR shape is owned by packages/kgraph/kgraph/src/types.ts',
  Objective: 'service-local objective shape is owned by packages/kgraph/kgraph/src/types.ts',
  UpsertObjectiveInput: 'service-local input shape is owned by packages/kgraph/kgraph/src/types.ts',
  MemoryQueryOptions: 'service-local options shape is owned by packages/memory/memory/src/types.ts',
  MemoryRecallResult: 'service-local result shape is owned by packages/memory/memory/src/types.ts',
  MemoryRecord: 'service-local record shape is owned by packages/memory/memory/src/types.ts',
  MemoryReflectOptions: 'service-local options shape is owned by packages/memory/memory/src/types.ts',
  MemoryRetainInput: 'service-local input shape is owned by packages/memory/memory/src/types.ts',
  MemorySummary: 'service-local summary shape is owned by packages/memory/memory/src/types.ts',
  ...
  SurfaceLine: 'service-local surface shape is owned by packages/prompt/prompt-context-trim/src/trim.ts',
  TrimOptions: 'service-local options shape is owned by packages/prompt/prompt-context-trim/src/trim.ts',
  TrimResult: 'service-local result shape is owned by packages/prompt/prompt-context-trim/src/trim.ts',
  IngestOptions: 'service-local options shape is owned by packages/prompt/prompt-corpus/src/index.ts',
  IngestResult: 'service-local result shape is owned by packages/prompt/prompt-corpus/src/index.ts',
  PromptCorpusSummary: 'service-local summary shape is owned by packages/prompt/prompt-corpus/src/index.ts',
  PromptRecallOptions: 'service-local options shape is owned by packages/prompt/prompt-corpus/src/index.ts',
  PromptRecallResult: 'service-local result shape is owned by packages/prompt/prompt-corpus/src/index.ts',
  TurnSurface: 'service-local turn-surface shape is owned by packages/prompt/prompt-lume/src/index.ts',
  CostSidecar: 'service-local cost counters are owned by packages/prompt/prompt-lume/src/cost.ts',
}
