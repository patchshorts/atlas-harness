/**
 * Package-owned invariant companion for `@atlasai/atsh-session-telemetry`.
 * @module @atlasai/atsh-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-session-telemetry'
