 ...
 * model-facing render consumes ({@link module:@atlasai/atsh-tool-fs-search/search-core}
 ...
 *
 * @module @atlasai/atsh-tool-fs-search/presentation
 */
 ...
 * ({@link module:@atlasai/atsh-tool-fs-search/grep} `formatGrepMatches`), so
