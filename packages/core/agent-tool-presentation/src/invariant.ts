/**
 * Package-owned invariant companion for `@atlasai/atsh-agent-tool-presentation`.
 * @module @atlasai/atsh-agent-tool-presentation/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-agent-tool-presentation'
