/**
 * @atlasai/atsh-cmdline — the command line a atsh launcher hands to the app
 * it boots.
 *
 ...
 * verbatim and in argv order. `atsh --profile tui --resume abc` yields
 * `['--resume', 'abc']`.
 */
