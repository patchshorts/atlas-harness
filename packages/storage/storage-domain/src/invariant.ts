/**
 * Package-owned invariant companion for `@atlasai/atsh-storage-domain`: every
 ...
 * @module @atlasai/atsh-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-storage-domain'
