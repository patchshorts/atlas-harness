...
import type { CordisCatalogModel, ServiceMethodEntry } from '@atlasai/atsh-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('@atlasai/atsh-tool-cordis/api-catalog', '@atlasai/atsh-cordis-client-runner/client/api-catalog')
