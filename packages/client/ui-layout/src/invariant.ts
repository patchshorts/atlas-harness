/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-layout`.
 * @module @atlasai/atsh-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-layout'
