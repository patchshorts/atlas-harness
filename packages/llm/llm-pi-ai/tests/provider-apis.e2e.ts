...
} from '@atlasai/atsh-attachment'
import LlmRuntime, { createUserMessage, CallId } from '@atlasai/atsh-llm'
import type { Message, ToolSchema } from '@atlasai/atsh-llm'
import * as LlmPiAi from '@atlasai/atsh-llm-pi-ai'
...
const openAIBaseURL = process.env.ATSH_PI_AI_OPENAI_BASE_URL
...
const anthropicBaseURL = process.env.ATSH_PI_AI_ANTHROPIC_BASE_URL

const providerCases: ProviderCase[] = [
  {
    provider: 'openai',
    api: 'openai-responses',
    model: process.env.ATSH_PI_AI_OPENAI_MODEL ?? 'gpt-5.5',
    ...azureOpenAIKey
  ...
  },
  {
    ...
    model: process.env.ATSH_PI_AI_ANTHROPIC_MODEL ?? 'claude-opus-4-8',
