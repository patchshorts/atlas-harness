/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-attachment`.
 * @module @atlasai/atsh-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-attachment'
