/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-tool`.
 * @module @atlasai/atsh-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-tool'
