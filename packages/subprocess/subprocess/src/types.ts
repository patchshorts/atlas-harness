...
export const ATSH_ENV_PREFIX = 'ATSH_' as const

/** One environment key inside the managed {@link ATSH_ENV_PREFIX} namespace. */
export type DshEnvironmentKey = `${typeof ATSH_ENV_PREFIX}${string}`
 ...
 * to `TerminalSignal` in `@atlasai/atsh-terminal` without a cross-seam dependency;
