/**
 * Package-owned invariant companion for `@atlasai/atsh-session-projection`.
 * @module @atlasai/atsh-session-projection/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-session-projection'
