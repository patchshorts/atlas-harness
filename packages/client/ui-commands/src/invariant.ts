/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-commands`.
 * @module @atlasai/atsh-client-ui-commands/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-commands'
