/**
 * Package-owned invariant companion for `@atlasai/atsh-session-query-sqlite`.
 * @module @atlasai/atsh-session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-session-query-sqlite'
