/**
 * Package-owned invariant companion for `@atlasai/atsh-session-persistence`.
 * @module @atlasai/atsh-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-session-persistence'
