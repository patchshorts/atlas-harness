/**
 * Package-owned invariant companion for `@atlasai/atsh-agent-instructions`.
 * @module @atlasai/atsh-agent-instructions/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-agent-instructions'
