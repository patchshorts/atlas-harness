/**
 * Package-owned invariant companion for `@atlasai/atsh-client-locale`.
 * @module @atlasai/atsh-client-locale/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-locale'
