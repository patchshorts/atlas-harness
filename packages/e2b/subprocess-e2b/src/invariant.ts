/**
 * Package-owned invariant companion for `@atlasai/atsh-subprocess-e2b`.
 * @module @atlasai/atsh-subprocess-e2b/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-subprocess-e2b'
