...
- **`ctx.appExit` is launcher-owned** — booting the headless profile outside the `atsh` launcher fails loud at activation until the host provides the exit request.
