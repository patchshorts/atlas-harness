...
suite('persistent Bash through a real cordis.yml Loader composition', () => {
  it('preserves cwd and environment across calls', async () => {
    ...
    await writeFile(configPath, [
      ...
      '    timeoutMs: 2000',
      '    disposeGraceMs: 500',
      "- name: '@atlasai/atsh-tool-bash-persistent'",
      '  config:',
      '    timeoutMs: 5000',
      '',
    ].join('\n'))
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@atlasai/atsh-tool-bash-persistent', ToolBashPersistent],
    ])
    ...
    expect(observed).not.toContain('ATSH_PERSISTENT_BASH')
    ...
    expect(multiline).not.toContain('ATSH_PERSISTENT_BASH')
