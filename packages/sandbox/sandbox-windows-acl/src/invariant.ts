/**
 * Package-owned invariant companion for `@atlasai/atsh-sandbox-windows-acl`.
 * @module @atlasai/atsh-sandbox-windows-acl/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-sandbox-windows-acl'
