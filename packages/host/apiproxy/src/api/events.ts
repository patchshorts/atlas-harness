...
import type { AskUserQuestionItem } from '@atlasai/atsh-user-questions/types'
import type { ApprovalOutcome, ApprovalRequestId } from '@atlasai/atsh-user-approval/types'
import type { Message } from '@atlasai/atsh-llm/types'
import type { MessageId } from '@atlasai/atsh-llm/brand'
import type { CallId } from '@atlasai/atsh-llm/brand'
import type { JsonValue, SessionEvent, SessionId } from '@atlasai/atsh-session/types'
import type { ToolCallView, ToolResultView } from '@atlasai/atsh-tools/presentation'
...
export type { ToolCallView, ToolResultView } from '@atlasai/atsh-tools/presentation'
...
export type HostFrame =
   ...
   * owned by `@atlasai/atsh-api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),
