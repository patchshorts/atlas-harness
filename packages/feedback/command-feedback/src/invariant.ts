/**
 * Package-owned invariant companion for `@atlasai/atsh-command-feedback`.
 * @module @atlasai/atsh-command-feedback/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-command-feedback'
