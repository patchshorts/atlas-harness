...
import type { ModelSelection, SessionModels } from '@atlasai/atsh-api-remotes/client'
import type { ClientContext } from '@atlasai/atsh-client-runtime/client'
import type { CommandUiContract, SelectOption } from '@atlasai/atsh-client-ui-commands/client'
// Type-only: pulls the ui-conversation SlotMap merge (the input.model seat).
import type {} from '@atlasai/atsh-client-ui-conversation/client'
// Type-only: pulls the locale plugin's Context merge (ctx.locale).
import type {} from '@atlasai/atsh-client-locale/client'
import type { TranslateNS } from '@atlasai/atsh-client-ui-slots'
