...
import SessionStore, { SESSION_FORMAT_VERSION, SessionId } from '@atlasai/atsh-session'
import type { SessionEvent, SessionHeader } from '@atlasai/atsh-session'
...
import type { ProjectionDefinition } from '@atlasai/atsh-session-projection'
import SessionProjectionCache from '@atlasai/atsh-session-projection-cache'
import Storage from '@atlasai/atsh-storage'
import { DomainFacility } from '@atlasai/atsh-storage-domain'
import { MemoryMediaPool, MemoryStorageBackend } from '../../../storage/storage-domain/tests/helpers/memory-backend.ts'
import SubagentRuntime, {
  SUBAGENT_DESCRIPTOR_VERSION,
  SubagentError,
} from '@atlasai/atsh-subagent'
import * as SubagentSpawn from '@atlasai/atsh-subagent-spawn-in-process'
import * as SubagentFork from '@atlasai/atsh-subagent-fork-in-process'
...
declare module '@atlasai/atsh-session-projection/types' {
