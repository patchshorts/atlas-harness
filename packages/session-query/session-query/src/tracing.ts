...
import { foldSurface, isSurfaceEvent, snapshotSessionEvent } from '@atlasai/atsh-session'
import type { SessionEvent, SessionId, SurfaceEvent, SurfaceEventType } from '@atlasai/atsh-session'
