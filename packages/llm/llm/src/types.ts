...
export interface GenerateOptions {
  ...
  /**
   * Cost-accounting session key for the per-session budget ledger. Absent
   * means the default session. Independent of {@link sessionId}: one logical
   * session may stamp the same accounting key across calls without sharing
   * routing identity.
   */
  sessionKey?: string
  /**
