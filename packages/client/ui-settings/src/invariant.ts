/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-settings`.
 * @module @atlasai/atsh-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-settings'
