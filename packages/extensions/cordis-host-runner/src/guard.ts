 ...
 * @module @atlasai/atsh-cordis-host-runner/guard
 */

import { Context } from '@deepseek-ai/cordis'
import type { Plugin } from '@deepseek-ai/cordis'
import { scopeOf } from '@atlasai/atsh-scope'
import { assertSupportedJsonSchema, defineTool } from '@atlasai/atsh-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@atlasai/atsh-cordis-client-runner`, whose CTX_VERBS names this one its
