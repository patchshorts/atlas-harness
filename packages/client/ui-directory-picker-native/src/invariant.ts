/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-directory-picker-native`.
 * @module @atlasai/atsh-client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-directory-picker-native'
