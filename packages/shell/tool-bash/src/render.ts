 ...
 *
 * @module @atlasai/atsh-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@atlasai/atsh-shell'
import type { SandboxMode } from '@atlasai/atsh-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@atlasai/atsh-sandbox'
 ...
 * rendering story, owned by `@atlasai/atsh-shell` so `dsh-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@atlasai/atsh-shell'
