...
import { createUserMessage, CallId, HarnessError, type ContentBlock  } from '@atlasai/atsh-llm'
import SystemPrompt from '@atlasai/atsh-system-prompt'
import type { Agent } from '@atlasai/atsh-agent'
import ApprovalService, { type ApprovalOutcome, type ApprovalRequest } from '@atlasai/atsh-user-approval'
import ToolRuntime, {
