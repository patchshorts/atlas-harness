...
import { TypertLookupFailure } from '@atlasai/atsh-typert-protocol'
import TypertRegistry from '@atlasai/atsh-typert-registry'
import { createUserMessage, MessageId } from '@atlasai/atsh-llm'
import type { Agent } from '@atlasai/atsh-agent'
import UserQuestionService from '@atlasai/atsh-user-questions'
import type { SessionEvent, SessionHeader, SessionId } from '@atlasai/atsh-session'
import {
  PersistenceCoordinator,
  SessionPersistenceRevision,
  type PersistenceBackend,
  type StoredPrefix,
} from '@atlasai/atsh-session-persistence'
import type { RpcRequest } from '@atlasai/atsh-host-apiproxy/api/rpc'
...
describe('Remote Agent and Session lookup policy', () => {
  it('deduplicates a cold resume across Agent and Session parameters', async () => {
    ...
    const resumedSession = { id: sessionId, header: meta, events: [] } as unknown as import('@atlasai/atsh-session').Session
