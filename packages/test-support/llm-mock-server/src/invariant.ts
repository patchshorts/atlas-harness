/**
 * Package-owned invariant companion for `@atlasai/atsh-llm-mock-server`.
 * @module @atlasai/atsh-llm-mock-server/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-llm-mock-server'
