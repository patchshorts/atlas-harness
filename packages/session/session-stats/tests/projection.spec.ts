...
import { createMessage } from '@atlasai/atsh-llm'
...
import { sessionStatsProjectionDefinition } from '@atlasai/atsh-session-stats/src/projection.ts'
import type { SessionStatsProjection } from '@atlasai/atsh-session-stats/types'
