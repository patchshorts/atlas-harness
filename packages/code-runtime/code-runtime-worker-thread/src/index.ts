 ...
 * @module @atlasai/atsh-code-runtime-worker-thread
 */
...
import { CodeRuntime, DUNDER_MEMBER, PORTABLE_RESERVED_WORDS, RESERVED_BINDING_GLOBALS, RESERVED_ERROR_MEMBERS } from '@atlasai/atsh-code-runtime'
import type { CodeBindingNamespace, CodeJsonValue, CodeRunFailure, CodeRunRequest, CodeRunResult } from '@atlasai/atsh-code-runtime'
 ...
 */
const STRIP_WRAP = { prefix: 'async function __atsh_program__() {\n', suffix: '\n}' } as const
