 ...
 * @module @atlasai/atsh-agent-presets/discovery
 */
...
import { expandHomePath } from '@atlasai/atsh-home-paths'
 ...
 * `<atshHome>/skills`. An app must assemble the SHIPPED root, whose path only
