...
import type { SessionProjectionRegistry } from '@atlasai/atsh-session-projection'
import type { SessionProjectionCache } from '@atlasai/atsh-session-projection-cache'
...
async function prepareListing(
  ...
  if (projections === undefined) {
    throw new SubagentError(
      'listing subagents requires the sessionProjections registry (load @atlasai/atsh-session-projection)',
  ...
  if (sessions === undefined) {
    throw new SubagentError(
      'listing subagents requires the session store (load @atlasai/atsh-session)',
