/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-workspace`.
 * @module @atlasai/atsh-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-workspace'
