 ...
 * @module @atlasai/atsh-tool-fs/src/read-image
 */

import { basename, extname } from 'node:path'
import type { Context } from '@deepseek-ai/cordis'
import { AttachmentError, AttachmentId } from '@atlasai/atsh-attachment'
import type { ImageAttachmentRef, ImageMediaType } from '@atlasai/atsh-attachment'
...
import type { GenericCallView, ToolExecution } from '@atlasai/atsh-tools'
import type {} from '@atlasai/atsh-fs'
