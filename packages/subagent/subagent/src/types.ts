 ...
 *
 * @module @atlasai/atsh-subagent/types
 */

import type { Agent, AgentOptions } from '@atlasai/atsh-agent'
...
import type { ObjectJsonSchema, ToolRestriction } from '@atlasai/atsh-tools'
