...
def test_default_config_is_shipped_with_the_package() -> None:
    ...
    assert "@atlasai/atsh-agent-spine-demo" in config
    assert "@atlasai/atsh-session-persistence-jsonl" in config
    assert "@atlasai/atsh-session-checkpoint-policy" in config
