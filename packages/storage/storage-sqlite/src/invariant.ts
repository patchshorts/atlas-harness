/**
 * Package-owned invariant companion for `@atlasai/atsh-storage-sqlite`.
 * @module @atlasai/atsh-storage-sqlite/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-storage-sqlite'
