/** Local durable attachment backend rooted below `ATSH_HOME`. @module @atlasai/atsh-attachment-local */
...
export class LocalAttachmentStore extends AttachmentStore {
  ...
  constructor(ctx: Context, config: Config) {
    super(ctx)
    this.root = resolve(join(resolveDshHome(config.atshHome), 'attachments', 'v1'))
