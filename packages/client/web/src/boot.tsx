 ...
 * `window.__ATSH_BOOT__` into the two-view BootManifest (wire boundary)
...
import * as ModulesClient from '@atlasai/atsh-client-modules/client'
import {
  ClientModuleSystem, parseBootManifest,
  type BootManifest, type ClientModuleSystemOptions, type DshWindow,
} from '@atlasai/atsh-client-modules/client'
 ...
 * twice.
 */
const MODULES_ID = '@atlasai/atsh-client-modules'
...
export class AppWebEntry {
  ...
  async run(): Promise<void> {
    this.manifest = parseBootManifest((globalThis as DshWindow).__ATSH_BOOT__)
    ...
    ;(globalThis as DshWindow).__ATSH_MODULES__ = this.modules
