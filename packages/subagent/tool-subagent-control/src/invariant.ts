/**
 * Package-owned invariant companion for `@atlasai/atsh-tool-subagent-control`.
 * @module @atlasai/atsh-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-tool-subagent-control'
