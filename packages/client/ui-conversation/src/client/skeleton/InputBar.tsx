...
} from '@atlasai/atsh-client-ui-primitives'
import { AttachmentRail, DropOverlay, ImageLightbox } from '@atlasai/atsh-client-ui-attachment'
import type { AttachmentRailItem } from '@atlasai/atsh-client-ui-attachment'
// Type-only: the `plan` projection key merge (the TodoDock posture — the
// composer reads a host-computed value; the domain owns the key).
import type {} from '@atlasai/atsh-plan-mode/client'
// Type-only: the `goal` projection key merge (hint disambiguation).
import type {} from '@atlasai/atsh-goal/client'
...
import type { Translate } from '@atlasai/atsh-client-ui-slots'
