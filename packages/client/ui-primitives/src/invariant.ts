/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-primitives`.
 * @module @atlasai/atsh-client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-primitives'
