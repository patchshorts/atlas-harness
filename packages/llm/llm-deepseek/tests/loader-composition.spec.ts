...
import LocalCredentialProvider from '@atlasai/atsh-credentials-local'
import { settingsNamespace } from '@atlasai/atsh-settings'
import FileSettingsProvider from '@atlasai/atsh-settings-file'
...
async function loadComposition(
  ...
  await writeFile(configPath, [
    ...
    ...options.withDynamic
      ? [
        '- id: settings',
        "  name: '@atlasai/atsh-settings-file'",
        '  config:',
        `    path: ${JSON.stringify(settingsPath)}`,
        '    debounceMs: 10',
        '- id: credentials',
        "  name: '@atlasai/atsh-credentials-local'",
        '  config:',
      ...
      : [],
    '- id: llm-deepseek',
    "  name: '@atlasai/atsh-llm-deepseek'",
    '  config:',
  ...
  const modules = new Map<string, unknown>([
    ...
    ['@atlasai/atsh-settings-file', FileSettingsProvider],
    ['@atlasai/atsh-credentials-local', LocalCredentialProvider],
    ['@atlasai/atsh-llm-deepseek', LlmDeepSeek],
  ])
  ctx.loader.internal = {
    version: 'v2',
