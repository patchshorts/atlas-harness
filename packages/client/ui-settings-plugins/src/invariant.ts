/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-settings-plugins`.
 * @module @atlasai/atsh-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-settings-plugins'
