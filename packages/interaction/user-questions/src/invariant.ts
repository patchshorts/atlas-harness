/**
 * Package-owned invariant companion for `@atlasai/atsh-user-questions`.
 * @module @atlasai/atsh-user-questions/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-user-questions'
