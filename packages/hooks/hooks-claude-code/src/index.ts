 ...
 * @module @atlasai/atsh-hooks-claude-code
 */
...
import type { PostToolDecision, PreToolDecision, ToolExecution, ToolExecutionResult } from '@atlasai/atsh-tools'
import {
  appendHookInvoked,
  appendHookResult,
  createDetachedRuns,
...
} from '@atlasai/atsh-hook-protocol'
// Pulls in the declaration-merged subagent events and the identity pairing their
// start/end edges.
import type { SubagentRunId } from '@atlasai/atsh-subagent'
