/**
 * Package-owned invariant companion for `@atlasai/atsh-session-title-first-prompt-llm`.
 * @module @atlasai/atsh-session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-session-title-first-prompt-llm'
