...
import { SANDBOX_UNAVAILABLE, SandboxUnavailableError } from '@atlasai/atsh-sandbox'
import type { SandboxPolicy } from '@atlasai/atsh-sandbox'
import {
  LocalSandboxProvider,
} from '@atlasai/atsh-sandbox-local'
import type { Config } from '@atlasai/atsh-sandbox-local'
...
describe('the platform chains', () => {
  ...
  // live in @atlasai/atsh-sandbox-windows-acl/tests/provider-chain.spec.ts
