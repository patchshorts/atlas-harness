...
import { usePinnedBrowserLanguages } from '@atlasai/atsh-client-test-runtime'
import { createScope, scopeOf, SlotRegistry } from '@atlasai/atsh-client-runtime/client'
import type { SessionId } from '@atlasai/atsh-client-runtime/client'
import { apply, inject, InputTriggerService } from '@atlasai/atsh-client-ui-input-trigger/client'
import type { MenuViewInjected } from '@atlasai/atsh-client-ui-input-trigger/client'
