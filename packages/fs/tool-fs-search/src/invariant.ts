/**
 * Package-owned invariant companion for `@atlasai/atsh-tool-fs-search`.
 * @module @atlasai/atsh-tool-fs-search/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-tool-fs-search'
