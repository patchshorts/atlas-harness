/**
 * Package-owned invariant companion for `@atlasai/atsh-host-apiproxy`.
 * @module @atlasai/atsh-host-apiproxy/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-host-apiproxy'
