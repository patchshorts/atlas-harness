...
import type { ApprovalRequestId } from '@atlasai/atsh-user-approval'
import type { ApiProxy, MuxFrame, RpcRequest } from '@atlasai/atsh-host-apiproxy/api'
import type { RpcId } from '@atlasai/atsh-host-apiproxy/api/rpc'
import { RpcId as mintRpcId } from '@atlasai/atsh-host-apiproxy/api/rpc'
