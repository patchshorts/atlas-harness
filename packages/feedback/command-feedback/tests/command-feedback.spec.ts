...
import SessionStore, { foldSurface, Session, SessionId } from '@atlasai/atsh-session'
import { SessionTelemetryBackend, type SessionTelemetrySharingStatus } from '@atlasai/atsh-session-telemetry'
...
vi.mock('@atlasai/atsh-anonymous-user-id', () => ({
...
describe('@atlasai/atsh-command-feedback registration', () => {
