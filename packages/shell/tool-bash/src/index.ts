...
import { ESCALATION_TARGETS, approveEscalation, canonicalPath, validateEscalationArgs } from '@atlasai/atsh-sandbox'
...
function bashDescription(backgroundEnabled: boolean, escalationModes: readonly SandboxMode[]): string {
  ...
  const base = 'Execute a bash command (`bash -c`) and return its stdout/stderr. '
    ...
    + `Current harness environment facts are exposed through managed \`$${ATSH_ENV_PREFIX}*\` variables; inspect them when needed. `
