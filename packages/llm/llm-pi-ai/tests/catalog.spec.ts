...
import LlmRuntime, { createUserMessage } from '@atlasai/atsh-llm'
import type { StreamChunk } from '@atlasai/atsh-llm'
...
/** A throwaway $ATSH_HOME with an empty settings document. */
