/** Package-owned invariant companion for the directory-picker seam. @module @atlasai/atsh-host-directory-picker/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@atlasai/atsh-invariants'

const PACKAGE_NAME = '@atlasai/atsh-host-directory-picker'
