/**
 * Package-owned invariant companion for `@atlasai/atsh-session-persistence-sqlite`.
 * @module @atlasai/atsh-session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-session-persistence-sqlite'
