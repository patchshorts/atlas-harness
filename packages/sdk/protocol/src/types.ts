 ...
 * plugin (`@atlasai/atsh-sdk-jsonrpc-server`) and SDK clients share these shapes;
 * `serverInfo.name` stays the wire-stable `deepseek-harness-sdk-runtime`.
 *
 * @module @atlasai/atsh-sdk-protocol/types
 */

import type { ContentBlock } from '@atlasai/atsh-llm'
import type { SessionEvent } from '@atlasai/atsh-session'
import type { SubagentStopReason } from '@atlasai/atsh-subagent'
