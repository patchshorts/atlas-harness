...
import type { GenericCallView, JsonValue, ToolResult, WebFetchResultView } from '@atlasai/atsh-tools'
import type { WebFetchBody, WebFetchResult } from '@atlasai/atsh-web'
 ...
 * `@atlasai/atsh-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@atlasai/atsh-tool-call-timeout-policy` to enforce.
