...
Emitted after one usage chunk is recorded into the per-session cost ledger. Carries the session total after the record. Listeners observe and never veto; the event is advisory accounting state.
...
Source: [`packages/llm/llm/src/index.ts:111`](../../packages/llm/llm/src/index.ts)
...
Source: [`packages/llm/llm/src/index.ts:102`](../../packages/llm/llm/src/index.ts)
