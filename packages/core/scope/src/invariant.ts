/** Package-owned scoped-dispatch invariants. @module @atlasai/atsh-scope/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@atlasai/atsh-invariants'
import { carrierKeyOf, isScopeCarrier } from '@atlasai/atsh-scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@atlasai/atsh-scope'
