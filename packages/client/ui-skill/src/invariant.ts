/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-skill`.
 * @module @atlasai/atsh-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-skill'
