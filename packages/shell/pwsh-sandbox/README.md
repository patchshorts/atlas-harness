...
- **Reads are unrestricted** on Windows (the ACL runner restricts writes only); the read boundary is documented in `@atlasai/atsh-sandbox-windows-acl`.
