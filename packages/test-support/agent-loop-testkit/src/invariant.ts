/**
 * Package-owned invariant companion for `@atlasai/atsh-agent-loop-testkit`.
 * @module @atlasai/atsh-agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-agent-loop-testkit'
