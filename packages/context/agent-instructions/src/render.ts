 ...
 *
 * @module @atlasai/atsh-agent-instructions/render
 */
...
/**
 * File name of the single user-global instruction file under `$ATSH_HOME`.
 * Discovery (`$ATSH_HOME/<name>`) and reconciliation (the user-global scope key's
...
export function scopeForDisplayPath(displayPath: string): string {
  if (displayPath === '~/.atsh/AGENTS.md' || displayPath === '$ATSH_HOME/AGENTS.md') return USER_GLOBAL_DIRECTORY
