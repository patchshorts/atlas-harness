...
| Package | Role |
|---|---|
| `@atlasai/atsh-shell` (this) | Service Definition: abstract service + vocabulary types |
| `@atlasai/atsh-bash-local` | Service Provider: local subprocesses |
| `@atlasai/atsh-bash-sandbox` | Service Provider: `dsh-bash-local`'s mechanics with every spawn confined via [`ctx.sandbox`](../../sandbox/sandbox/), denials reported as result facts |
| `@atlasai/atsh-tool-bash` | the model-facing tool schemas over `ctx.shell` |
