/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-input-trigger`.
 * @module @atlasai/atsh-client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-input-trigger'
