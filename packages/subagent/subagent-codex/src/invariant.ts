/**
 * Package-owned invariant companion for `@atlasai/atsh-subagent-codex`.
 * @module @atlasai/atsh-subagent-codex/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-subagent-codex'
