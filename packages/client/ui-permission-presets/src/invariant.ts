/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-permission-presets`.
 * @module @atlasai/atsh-client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-permission-presets'
