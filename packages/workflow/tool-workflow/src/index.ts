 ...
 * (`@atlasai/atsh-workflow`), so a hardened engine swaps in without touching what the model
 ...
 * @module @atlasai/atsh-tool-workflow
 */

import type { Context } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { defineTool } from '@atlasai/atsh-tools'
import type { ToolCallView, ToolResultView } from '@atlasai/atsh-tools'
import type { ContentBlock } from '@atlasai/atsh-llm'
import type { JsonValue, Session, SessionEventMap } from '@atlasai/atsh-session'
import type {
