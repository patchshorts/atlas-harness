 ...
 * `@atlasai/atsh-fs` Service Definition. It extends `LocalFileSystem` so all
 ...
 * stays `ctx.shell`'s job (`@atlasai/atsh-bash-sandbox`). This mirrors the
 ...
 * escalation retry lives in the tool layer (`@atlasai/atsh-tool-fs`),
 * exactly as bash's does.
 *
 * @module @atlasai/atsh-fs-sandbox
 */

import { Context } from '@deepseek-ai/cordis'
import { LocalFileSystem } from '@atlasai/atsh-fs-local'
import type { Config as LocalConfig } from '@atlasai/atsh-fs-local'
import { FsError } from '@atlasai/atsh-fs'
import type { FsEditOutcome, FsEditRequest, FsTarget, FsVersion, FsWriteIntent, FsWriteOutcome } from '@atlasai/atsh-fs'
import { writableRoots } from '@atlasai/atsh-sandbox'
import type { SandboxExecutionPolicy, SandboxMode } from '@atlasai/atsh-sandbox'
import type {} from '@atlasai/atsh-sandbox-policy'
