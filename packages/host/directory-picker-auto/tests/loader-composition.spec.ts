...
import HttpServer from '@atlasai/atsh-host-webserver'
import type { DirectoryPicker } from '@atlasai/atsh-host-directory-picker'
import BrowseDirectoryPicker from '@atlasai/atsh-host-directory-picker-browse'
import NativeDirectoryPicker from '@atlasai/atsh-host-directory-picker-native'
...
const AUTO = '@atlasai/atsh-host-directory-picker-auto'
const NATIVE = '@atlasai/atsh-host-directory-picker-native'
const BROWSE = '@atlasai/atsh-host-directory-picker-browse'
const NATIVE_SURFACE = '@atlasai/atsh-client-ui-directory-picker-native'
const BROWSE_SURFACE = '@atlasai/atsh-client-ui-directory-picker-browse'
...
async function loadComposition(
  ...
  await writeFile(configPath, [
    "- name: '@atlasai/atsh-host-webserver'",
    '  config:',
    `    host: '${bindHost}'`,
    '    port: 0',
    `- name: '${AUTO}'`,
  ...
  const modules = new Map<string, unknown>([
    ['@atlasai/atsh-host-webserver', HttpServer],
