 ...
 * @module @atlasai/atsh-session-title
 */
...
import { assertNever, deepFreeze, isAgentLoopRequest } from '@atlasai/atsh-llm'
import type { GenerateOptions } from '@atlasai/atsh-llm'
import type {
  Session,
  SessionEvent,
