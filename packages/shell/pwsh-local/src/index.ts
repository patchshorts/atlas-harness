 ...
 *
 * @module @atlasai/atsh-pwsh-local
 */
...
import { SHELL_SETTINGS_NAMESPACE, ShellExecutor } from '@atlasai/atsh-shell'
import type { ShellExecRequest, ShellExecSpec, ShellProcess, ShellProcessRead, ShellRunResult, CollectedOutput } from '@atlasai/atsh-shell'
import type { SubprocessCollect, SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@atlasai/atsh-subprocess'
import { installSettingsSection } from '@atlasai/atsh-settings'
import { clampTimeout, deadline, MAX_TIMER_DELAY_MS, timeoutOf } from '@atlasai/atsh-timeout'
/* jscpd:ignore-end */
...
export class PwshLocalExecutor extends ShellExecutor {
   ...
   * pwsh-confining consumer is `@atlasai/atsh-pwsh-sandbox`.
