/**
 * Package-owned invariant companion for `@atlasai/atsh-sdk-jsonrpc-server`.
 * @module @atlasai/atsh-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-sdk-jsonrpc-server'
