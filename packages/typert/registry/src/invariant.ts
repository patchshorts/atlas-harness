/**
 * Package-owned invariant companion for `@atlasai/atsh-typert-registry`.
 * @module @atlasai/atsh-typert-registry/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-typert-registry'
