 ...
 *
 * @module @atlasai/atsh-agent-instructions/config
 */
...
export function resolveDiscoveryConfig(
  config: Pick<Config, 'atshHome' | 'projectRootMarkers' | 'instructionFileCandidates' | 'localInstructionFileCandidates'>,
): ResolvedDiscoveryConfig {
  return {
    atshHome: resolveDshHome(config.atshHome),
