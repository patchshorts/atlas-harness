...
function checkManifest(
  ...
  if (owner.packageName === '@atlasai/atsh-invariants') return
  if (manifest.peerDependencies?.['@atlasai/atsh-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@atlasai/atsh-invariants must be a workspace:^ peerDependency',
    )
  }
  if (manifest.devDependencies?.['@atlasai/atsh-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@atlasai/atsh-invariants must also be a workspace:^ devDependency',
    )
  }
}
...
function checkBuild(
  ...
  if (owner.packageName !== '@atlasai/atsh-invariants'
