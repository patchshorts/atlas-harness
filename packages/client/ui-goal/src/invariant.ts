/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-goal`.
 * @module @atlasai/atsh-client-ui-goal/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-goal'
