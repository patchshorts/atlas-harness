 ...
 * @module @atlasai/atsh-client-modules/client
 */
...
export function apply(ctx: Context): void {
  const modules = (globalThis as DshWindow).__ATSH_MODULES__
  ...
  if (modules === undefined) {
    throw new Error('client-modules: window.__ATSH_MODULES__ missing — the shell kernel must construct the module system before plugin boot')
  }
