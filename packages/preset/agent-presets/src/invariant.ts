/**
 * Package-owned invariant companion for `@atlasai/atsh-agent-presets`.
 * @module @atlasai/atsh-agent-presets/invariant
 */
...
import { leakedServices, livePresetMounts } from '@atlasai/atsh-agent-presets'

const PACKAGE_NAME = '@atlasai/atsh-agent-presets'
