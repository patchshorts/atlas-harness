...
import InvariantService from '@atlasai/atsh-invariants'
import type {
  ApprovalRequestId, CordisDynamicPackageId, CordisDynamicPluginId, CordisDynamicPluginRunId,
} from '@atlasai/atsh-api-remotes/client'
import type { SessionId } from '@atlasai/atsh-client-connection/client'
import type { DynamicCordisInvokeResult } from '@atlasai/atsh-api-remotes/client'
// Type-only: resolves `ctx.remote` and with it the `$on`/`$dispatch` surface.
import type {} from '@atlasai/atsh-api-gateway/client'
