...
import type { JobView } from '@atlasai/atsh-client-runtime/client'
import { IconChevronDownOutline14, StateDot, type StateDotState } from '@atlasai/atsh-client-ui-primitives'
