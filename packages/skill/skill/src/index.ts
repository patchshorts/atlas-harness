 ...
 * Concrete
 * providers such as `@atlasai/atsh-skill-filesystem` decide where skills come
 ...
 *
 * @module @atlasai/atsh-skill
 */

import { Context, Service } from '@deepseek-ai/cordis'
import { assertNever } from '@atlasai/atsh-llm'
import { NamedEntries, ScopedLayers, scopeChainOf, scopeOf } from '@atlasai/atsh-scope'
import type { ScopeKey, ScopeLayer } from '@atlasai/atsh-scope'
