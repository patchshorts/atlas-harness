 ...
 *
 * @module @atlasai/atsh-tool-fs-search/search-core
 */

import { isAbsolute, relative, sep } from 'node:path'
import type { Context } from '@deepseek-ai/cordis'
import { HarnessError } from '@atlasai/atsh-llm'
import { ItemRetainer, TextRetainer } from '@atlasai/atsh-output-retention'
import type { RetainedItems } from '@atlasai/atsh-output-retention'
import type { SubprocessHandle, SubprocessOutcome, SubprocessOutputRead, SubprocessSpawnSpec } from '@atlasai/atsh-subprocess'
import type { SaveTextSpill, SpillRef } from '@atlasai/atsh-spill'
 ...
 * `@atlasai/atsh-tool-call-timeout-policy` to enforce through `exec.signal`.
 */
 ...
 * (`@atlasai/atsh-tool-call-timeout-policy`) and caller cancellation terminate the
 * process tree.
 *
 ...
 * retention pass both the model-facing render ({@link module:@atlasai/atsh-tool-fs-search/grep}
 * `formatGrepOutput`) and the search-card projection
 * ({@link module:@atlasai/atsh-tool-fs-search/presentation} `grepSearchMeta`)
