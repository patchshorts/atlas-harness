/**
 * Package-owned invariant companion for `@atlasai/atsh-code-runtime-worker-thread`.
 * @module @atlasai/atsh-code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-code-runtime-worker-thread'
