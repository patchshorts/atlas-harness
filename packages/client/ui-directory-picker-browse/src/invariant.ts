/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-directory-picker-browse`.
 * @module @atlasai/atsh-client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-directory-picker-browse'
