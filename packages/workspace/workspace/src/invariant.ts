/**
 * Package-owned invariant companion for `@atlasai/atsh-workspace`.
 * @module @atlasai/atsh-workspace/invariant
 */
...
import { WorkspaceId } from '@atlasai/atsh-workspace'

const PACKAGE_NAME = '@atlasai/atsh-workspace'
