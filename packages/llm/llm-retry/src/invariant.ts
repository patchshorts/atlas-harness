/** Package-owned durable retry-event invariants. @module @atlasai/atsh-llm-retry/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { Session, SessionEvent } from '@atlasai/atsh-session'
import type { LlmFailure } from '@atlasai/atsh-llm'
...
const PACKAGE_NAME = '@atlasai/atsh-llm-retry'
