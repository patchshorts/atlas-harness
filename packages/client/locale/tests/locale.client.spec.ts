...
import { stubSettingsScope, type StubSettingsScope } from '@atlasai/atsh-client-test-runtime'
import type { LocaleSettings, LocaleSnapshot } from '@atlasai/atsh-client-locale/client'
