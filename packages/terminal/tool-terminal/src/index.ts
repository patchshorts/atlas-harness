 ...
 * @module @atlasai/atsh-tool-terminal
 */
...
import { TerminalSessionId } from '@atlasai/atsh-terminal'
import type { TerminalSendResult, TerminalSessionId as TerminalSessionIdType, TerminalSignal } from '@atlasai/atsh-terminal'
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: SendArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) throw new Error('background terminal sends require @atlasai/atsh-jobs and @atlasai/atsh-tool-jobs')
