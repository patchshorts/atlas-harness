/**
 * Package-owned invariant companion for `@atlasai/atsh-command-compact`.
 * @module @atlasai/atsh-command-compact/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-command-compact'
