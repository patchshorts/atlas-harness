/**
 * Package-owned invariant companion for `@atlasai/atsh-terminal-bash`.
 * @module @atlasai/atsh-terminal-bash/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-terminal-bash'
