/**
 * Package-owned invariant companion for `@atlasai/atsh-tool-ask-user`.
 * @module @atlasai/atsh-tool-ask-user/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-tool-ask-user'
