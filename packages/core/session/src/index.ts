 ...
 *
 * @module @atlasai/atsh-session
 */

import { Context, Service } from '@deepseek-ai/cordis'
import { isAbsolute } from 'node:path'
import { deepFreeze } from '@atlasai/atsh-llm'
import { scopeOf, scopeTarget } from '@atlasai/atsh-scope'
import type { Scoped } from '@atlasai/atsh-scope'
import type { Message } from '@atlasai/atsh-llm'
import { SESSION_FORMAT_VERSION, SessionId } from './types.ts'
import type { TypertLookup } from '@atlasai/atsh-typert-protocol'
...
export type { AssistantMessage, ToolResultMessage, UserMessage } from '@atlasai/atsh-llm'
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('session', {
        parameter: 'session',
        wire: 'sessionId',
        hostTypeSymbol: '@atlasai/atsh-session#Session',
        wireTypeSymbol: '@atlasai/atsh-session/types#SessionId',
