/**
 * Package-owned invariant companion for `@atlasai/atsh-cordis-client-runner`.
 * @module @atlasai/atsh-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-cordis-client-runner'
