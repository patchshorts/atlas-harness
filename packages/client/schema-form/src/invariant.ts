/**
 * Package-owned invariant companion for `@atlasai/atsh-client-schema-form`.
 * @module @atlasai/atsh-client-schema-form/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-schema-form'
