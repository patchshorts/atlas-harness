 ...
 * mount it as a no-op.
 *
 * @module @atlasai/atsh-agent-instructions
 */
...
import type { ToolExecution, ToolExecutionResult, ToolExecutionToken } from '@atlasai/atsh-tools'
