...
import type { SessionProviderComponent, TranslateNS } from '@atlasai/atsh-client-ui-slots'
import type { DetailsSlotProps, DetailsToolOwnerProps } from '@atlasai/atsh-client-ui-conversation/src/client/contract/slots.ts'
