...
External packages that a workspace package resolves at runtime. The tier covers every plugin a user can mount from \`cordis.yml\` — not only what the \`atsh\` CLI, Web UI, and Python SDK runtime load by default.
