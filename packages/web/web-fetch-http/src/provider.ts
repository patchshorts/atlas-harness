 ...
 * `@atlasai/atsh-tool-web`. Requests carry no browser cookies or ambient credentials.
 *
 ...
 * @module @atlasai/atsh-web-fetch-http/provider
 */

import { WebError } from '@atlasai/atsh-web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@atlasai/atsh-web'
