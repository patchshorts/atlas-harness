...
import type { Agent, AgentFactory } from '@atlasai/atsh-agent'
...
import type { DirectoryPickerCapability } from '@atlasai/atsh-host-directory-picker'
import WorkspaceRegistry from '@atlasai/atsh-workspace'
import type { HostFrame, WorkspaceId } from '@atlasai/atsh-host-apiproxy/api'
import type { RpcRequest, RpcResponse } from '@atlasai/atsh-host-apiproxy/api/rpc'
import { RpcId } from '@atlasai/atsh-host-apiproxy/api/rpc'
import { createApiProxy } from '@atlasai/atsh-host-apiproxy'
