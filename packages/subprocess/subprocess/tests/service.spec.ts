...
import { scrubbedParentEnv, SubprocessRuntime } from '@atlasai/atsh-subprocess'
import type {
  SubprocessHandle,
...
describe('SubprocessRuntime seam', () => {
  ...
  it('scrubbedParentEnv drops credential-shaped and ATSH_ names (case-insensitively) but keeps PATH', () => {
    process.env.ATSH_SCRUB_PROBE = 'stale'
    ...
    try {
      ...
      expect(env.ATSH_SCRUB_PROBE).toBeUndefined()
      ...
      delete process.env.ATSH_SCRUB_PROBE
