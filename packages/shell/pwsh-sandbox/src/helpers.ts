 ...
 * mirror of `@atlasai/atsh-bash-sandbox/src/helpers.ts` (the pwsh twin of
 * the bash consumer shares the identical classification dialect).
 *
 * @module @atlasai/atsh-pwsh-sandbox/helpers
 */

/* jscpd:ignore-start */
import { accessSync, constants, statSync } from 'node:fs'
import type { ShellRunResult } from '@atlasai/atsh-shell'
import type { RunnerFailureRule } from '@atlasai/atsh-sandbox'
