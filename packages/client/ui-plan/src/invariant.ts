/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-plan`.
 * @module @atlasai/atsh-client-ui-plan/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-plan'
