/** JSON string-prefix accounting for the outer-output ledger. @module @atlasai/atsh-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@atlasai/atsh-code-runtime'
