...
import { SlotRegistry, type SessionId } from '@atlasai/atsh-client-runtime/client'
import { ConversationEventRegistry } from '@atlasai/atsh-client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@atlasai/atsh-goal/client'
