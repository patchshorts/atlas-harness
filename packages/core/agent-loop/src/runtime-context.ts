 ...
 * @module @atlasai/atsh-agent-loop/runtime-context
 */

import { createUserMessage } from '@atlasai/atsh-llm'
import type { ContextSnapshotSection } from '@atlasai/atsh-llm'
import type { Session, UserMessage } from '@atlasai/atsh-session'
import { isReplacementSurfaceEvent } from '@atlasai/atsh-session'
import type { Context } from '@deepseek-ai/cordis'

const SOURCE = '@atlasai/atsh-system-prompt'
