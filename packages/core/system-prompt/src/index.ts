 ...
 *
 * @module @atlasai/atsh-system-prompt
 */

import { Context, Service } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { AnonymousEntries, NamedEntries, ScopedLayers, scopeTarget } from '@atlasai/atsh-scope'
import type { ScopeKey, ScopeLayer, Scoped } from '@atlasai/atsh-scope'
import type { ContextSnapshotSection, ToolSchema } from '@atlasai/atsh-llm'
...
declare module '@deepseek-ai/cordis' {
  ...
  interface Events {
     ...
     * Scope-filtered dispatch (`@atlasai/atsh-scope`): scoped listeners
