...
import { renderWorkspaceContext } from '@atlasai/atsh-agent-instructions'
import { resolveConfig, workspaceBaselineIdentity } from '@atlasai/atsh-agent-instructions/src/config.ts'
...
describe('agent-instructions resume snapshot', () => {
  it('appends an offline replacement without duplicating the visible baseline', async () => {
    ...
    const result = await runLoaderSmoke({
      ...
      tsconfigPath,
      env: {
        ATSH_SNAPSHOT_FILE: replayFixture,
