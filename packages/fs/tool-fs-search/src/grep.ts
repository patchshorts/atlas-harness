 ...
 *
 * @module @atlasai/atsh-tool-fs-search/grep
 */

import type { Context } from '@deepseek-ai/cordis'
import { defineTool } from '@atlasai/atsh-tools'
import type { GenericCallView, SearchResultView, ToolResult } from '@atlasai/atsh-tools'
import type { RetainedItems } from '@atlasai/atsh-output-retention'
import type { SpillRef } from '@atlasai/atsh-spill'
