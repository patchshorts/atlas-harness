/**
 * Package-owned invariant companion for `@atlasai/atsh-client-runtime`.
 * @module @atlasai/atsh-client-runtime/invariant
 */
...
import type { SlotMap } from '@atlasai/atsh-client-ui-slots'
import type { InvariantInstaller } from '@atlasai/atsh-invariants'

const PACKAGE_NAME = '@atlasai/atsh-client-runtime'
