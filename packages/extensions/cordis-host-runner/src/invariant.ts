/**
 * Package-owned invariant companion for `@atlasai/atsh-cordis-host-runner`.
 * @module @atlasai/atsh-cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-cordis-host-runner'
