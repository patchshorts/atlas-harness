/**
 * Package-owned invariant companion for `@atlasai/atsh-tool-subagent-report`.
 * @module @atlasai/atsh-tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-tool-subagent-report'
