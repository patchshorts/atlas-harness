/**
 * Unit + real-load-path coverage for @atlasai/atsh-tool-call-timeout-policy. The
...
import { CallId, HarnessError } from '@atlasai/atsh-llm'
import SystemPrompt from '@atlasai/atsh-system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@atlasai/atsh-tools'
import * as timeoutPolicy from '@atlasai/atsh-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@atlasai/atsh-tool-call-timeout-policy'
