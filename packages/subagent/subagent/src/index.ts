 ...
 * (`@atlasai/atsh-subagent-spawn-in-process`, `-fork`, `-acp`) and the model-facing
 * consumer (`@atlasai/atsh-tool-subagent`) are separate packages.
 *
...
import { assertObjectJsonSchema } from '@atlasai/atsh-tools'
import type { ContentBlock, MessageId } from '@atlasai/atsh-llm'
