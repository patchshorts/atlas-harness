 ...
 * @module @atlasai/atsh-agent-presets/mount
 */
...
import { scopeOf, scopeParentOf, type ScopeKey } from '@atlasai/atsh-scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@atlasai/atsh-*` row would fail to import. The
