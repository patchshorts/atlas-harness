/**
 * Package-owned invariant companion for `@atlasai/atsh-session-checkpoint-policy`.
 * @module @atlasai/atsh-session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-session-checkpoint-policy'
