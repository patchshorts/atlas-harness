/**
 * Package-owned invariant companion for `@atlasai/atsh-client-connection`.
 * @module @atlasai/atsh-client-connection/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-connection'
