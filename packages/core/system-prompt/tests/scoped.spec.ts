...
import { createScope, scopeOf } from '@atlasai/atsh-scope'
import type { Scope, ScopeKey } from '@atlasai/atsh-scope'
import SystemPrompt, { TOOL_ORDER_REST, renderContextSnapshot, renderPrompt } from '@atlasai/atsh-system-prompt'
import type { Config, PromptAssembly } from '@atlasai/atsh-system-prompt'
