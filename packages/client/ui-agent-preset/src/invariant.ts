/**
 * Package-owned invariant companion for `@atlasai/atsh-client-ui-agent-preset`.
 * @module @atlasai/atsh-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-ui-agent-preset'
