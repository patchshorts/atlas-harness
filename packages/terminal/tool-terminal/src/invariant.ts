/**
 * Package-owned invariant companion for `@atlasai/atsh-tool-terminal`.
 * @module @atlasai/atsh-tool-terminal/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-tool-terminal'
