...
import {
  ...
  createUserMessage,
  isTokenDelta,
} from '@atlasai/atsh-llm/message'
import { CallId } from '@atlasai/atsh-llm/brand'
import type {
  AssistantMessage,
  ContentBlock,
  MessageSource,
...
import type { AttachmentIdType, ImageAttachmentRef } from '@atlasai/atsh-attachment'
import type {
  SessionEvent,
  SessionId,
  TodoItem,
} from '@atlasai/atsh-session/types'
// Type-only: the brand constructor is host-side; the fixture casts at its
// wire-fabrication boundary (the schema layer's one-cast-point posture).
import type { CommandId } from '@atlasai/atsh-commands/brand'
import type { CommandDescriptor, CommandExecution, CommandResult } from '@atlasai/atsh-commands/types'
import { deriveEventMessage, foldSurface } from '@atlasai/atsh-session/surface'
import type {
  ApiProxy, ClientRequest, ClientResponse, HistoryEntry, HostFrame, MuxFrame, RpcReceipt,
  ModelProviderGroup, ModelSelection, RpcRequest, RpcResponse, RpcResult, ServerRequest, ServerResponse, SessionSummary,
  ToolCallView, ToolEventView, ToolResultView, WorkspaceId, WorkspaceView,
} from './api.ts'
import type { RequestPayload, ResponseValue, RpcMethodMap } from '@atlasai/atsh-host-apiproxy/api'
...
function createFixtureWorld(options: FixtureOptions): FixtureWorld {
  ...
  const fixturePresets = new Map<string, { trust: 'system' | 'user'; content: string }>([
    ['standard', { trust: 'system', content: "- id: tool-bash\n  name: '@atlasai/atsh-tool-bash'\n" }],
    ['minimal', { trust: 'system', content: "- id: tool-web-search\n  name: '@atlasai/atsh-tool-web-search'\n" }],
    ['my-agent', { trust: 'user', content: "- id: tool-read\n  name: '@atlasai/atsh-tool-read'\n" }],
  ])
