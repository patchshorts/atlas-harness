...
import { createUserMessage, HarnessError } from '@atlasai/atsh-llm'
import SessionStore, { Session, SessionId, type UserMessage } from '@atlasai/atsh-session'
import GoalService, {
  GoalError,
  GoalId,
  decodeGoalChange,
  foldGoal,
} from '@atlasai/atsh-goal'
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from '@atlasai/atsh-goal'
...
function stubAgent(rawId: string, seed?: readonly import('@atlasai/atsh-session').SessionEvent[]): StubAgent {
