 ...
 * @module @atlasai/atsh-tool-goal
 */

import type { Context } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { GoalId } from '@atlasai/atsh-goal'
import type { GoalRef, GoalView } from '@atlasai/atsh-goal'
import { boundContextSummary, createUserMessage, HarnessError } from '@atlasai/atsh-llm'
import { defineTool } from '@atlasai/atsh-tools'
import type { GenericCallView } from '@atlasai/atsh-tools'
