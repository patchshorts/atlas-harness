 ...
 *
 * @module @atlasai/atsh-session-telemetry-otel
 */

import { createRequire } from 'node:module'
import z from '@deepseek-ai/schemastery'
import type { Context } from '@deepseek-ai/cordis'
import type {} from '@atlasai/atsh-command-feedback'
import {
...
} from '@atlasai/atsh-session-telemetry'
import { APP_IDENTITY } from '@atlasai/atsh-llm'
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@atlasai/atsh-session-telemetry-otel', version)
    const ops = this.provider.getLogger('@atlasai/atsh-session-telemetry-otel/ops', version)
