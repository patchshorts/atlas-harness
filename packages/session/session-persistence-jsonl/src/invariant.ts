/**
 * Package-owned invariant companion for `@atlasai/atsh-session-persistence-jsonl`.
 * @module @atlasai/atsh-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-session-persistence-jsonl'
