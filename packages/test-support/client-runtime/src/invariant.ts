/**
 * Package-owned invariant companion for `@atlasai/atsh-client-test-runtime`.
 * @module @atlasai/atsh-client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-client-test-runtime'
