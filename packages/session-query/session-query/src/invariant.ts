/**
 * Package-owned invariant companion for `@atlasai/atsh-session-query`.
 * @module @atlasai/atsh-session-query/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-session-query'
