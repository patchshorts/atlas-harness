 ...
 * @module @atlasai/atsh-workflow-worker-thread/runtime
 */

import * as vm from 'node:vm'
import type { ContentBlock } from '@atlasai/atsh-llm'
import { SessionId } from '@atlasai/atsh-session'
import { assertObjectJsonSchema, JsonSchemaError } from '@atlasai/atsh-tools'
import type { ObjectJsonSchema } from '@atlasai/atsh-tools'
import { isFatalWorkflowError, WorkflowError } from '@atlasai/atsh-workflow'
import type {
