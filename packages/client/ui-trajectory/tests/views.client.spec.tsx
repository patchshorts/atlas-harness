...
import { bindSnapshotSelector } from '@atlasai/atsh-client-web-react'
import { resolveSlotLabel } from '@atlasai/atsh-client-ui-slots'
import {
  ConversationEventRegistry, ConversationViewRegistry, createSnapshotStore,
  EMPTY_CHAT_SNAPSHOT,
} from '@atlasai/atsh-client-runtime/client'
import { SlotRegistry } from '@atlasai/atsh-client-runtime/client'
import type {
  ConversationSnapshot, RequestView,
  SessionId, SessionListState, SnapshotStore, WorkspaceListState,
} from '@atlasai/atsh-client-runtime/client'
import type { ConvViewProps, ViewTab } from '@atlasai/atsh-client-ui-conversation/client'
import {
  ConversationSession, ConversationSessionHeader,
  type ConversationSessionHeaderProps, type ConversationSessionProps,
} from '@atlasai/atsh-client-ui-conversation/src/client/skeleton/ConversationSession.tsx'
import { createChatStore } from '@atlasai/atsh-client-ui-conversation/src/client/stores.ts'
import { zh as conversationZh } from '@atlasai/atsh-client-ui-conversation/src/client/locales.ts'
import { apply as localeApply, inject as localeInject } from '@atlasai/atsh-client-locale/client'
import { stubSettingsScope } from '@atlasai/atsh-client-test-runtime'
import type { LocaleKeysOf } from '@atlasai/atsh-client-ui-slots'
import { zh, type TrajectoryKey } from '../src/client/locales.ts'
import { apply, inject } from '@atlasai/atsh-client-ui-trajectory/client'
import { apply as nodeApply } from '@atlasai/atsh-client-ui-trajectory'
...
describe('plugin registration', () => {
  ...
  it('shares one browser-wide duration preference across session injections', async () => {
    ...
    expect(localStorage.getItem('atsh.trajectory.duration')).toBe('true')
    expect(localStorage.getItem(`atsh.trajectory.duration.${SID}`)).toBeNull()
  })
