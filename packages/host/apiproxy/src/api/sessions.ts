...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef, ImageMediaType } from '@atlasai/atsh-attachment'
import type { ContentBlock } from '@atlasai/atsh-llm/types'
import type { SessionEvent, SessionId } from '@atlasai/atsh-session/types'
// The pure-type outlet: api/ is browser-importable, and the package root's
// cordis Context merge (via dsh-agent) must not enter client aggregates.
import type { SessionProjectionMap } from '@atlasai/atsh-session-projection/types'
