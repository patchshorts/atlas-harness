/**
 * Package-owned invariant companion for `@atlasai/atsh-tool-call-timeout-policy`.
 * @module @atlasai/atsh-tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-tool-call-timeout-policy'
