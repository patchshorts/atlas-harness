 ...
 *
 * @module @atlasai/atsh-session-reference
 */
...
import type { ContentBlock, UserMessage } from '@atlasai/atsh-llm'
import type { SessionId } from '@atlasai/atsh-session'
import type { SessionSurfaceSnapshot, SessionTitleObservationResult } from '@atlasai/atsh-session-query'
import {
