/**
 * Package-owned invariant companion for `@atlasai/atsh-typert-protocol`.
 * @module @atlasai/atsh-typert-protocol/invariant
 */
...
const PACKAGE_NAME = '@atlasai/atsh-typert-protocol'
